...
@class ADAdImpressionPublicAttributes, ADSAdImpression, NSMutableSet, NSString, NSTimer;
...
+ (void)unregisterImpressionUUID:(id)arg1;
+ (void)registerImpressionUUIDForData:(id)arg1 impressionUUID:(id)arg2;
...
- (void)reportAdFrameSize:(struct CGRect)arg1 withCreativeSize:(struct CGRect)arg2 atScale:(float)arg3;
- (void)reportCreativeDidUnloadWithWithTotalRequestCount:(long long)arg1;
...
- (unsigned long long)getMaxBitrateForNetworkConditions;
- (id)_findBestMediaAsset;
