...
@interface SSSScreenshotsView : UIView <UIScrollViewDelegate, UINavigationBarDelegate, UIToolbarDelegate, SSSScreenshotViewDelegate, SSSInkPickerToolbarViewDelegate>
{
    ...
    NSMutableArray *_futureChildScreenshots;
...
- (_Bool)_shouldUpdateForKeyboardNotification:(id)arg1;
...
- (void)screenshotViewRequestsForeground:(id)arg1;
- (void)screenshotViewPropertiesChanged:(id)arg1;
...
- (id)_screenshotsIncludingFutureScreenshots;
...
- (struct CGRect)_rectForPage:(long long)arg1;
