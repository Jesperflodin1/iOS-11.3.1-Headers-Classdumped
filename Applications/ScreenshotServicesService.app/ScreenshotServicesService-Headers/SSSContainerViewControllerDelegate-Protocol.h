...
@class SSSContainerViewController;
...
- (void)containerViewController:(SSSContainerViewController *)arg1 requestsDismissWithVelocity:(double)arg2;
- (void)containerViewControllerRequestsDismiss:(SSSContainerViewController *)arg1;
- (void)containerViewControllerRequestsDeletionDismiss:(SSSContainerViewController *)arg1;
