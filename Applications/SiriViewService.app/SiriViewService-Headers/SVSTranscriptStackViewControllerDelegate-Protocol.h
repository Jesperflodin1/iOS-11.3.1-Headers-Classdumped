...
@class AFUserUtterance, AFUserUtteranceSelectionResults, AceObject<SAAceCommand>, NSArray, NSBundle, NSDate, NSIndexPath, NSString, NSURL, NSUUID, SASSpeechRecognized, SVSTranscriptStackViewController, UIView, UIViewController;
...
- (void)transcriptStackViewControllerConversationDidLoad:(SVSTranscriptStackViewController *)arg1;
- (void)transcriptStackViewControllerConversationWillLoad:(SVSTranscriptStackViewController *)arg1;
