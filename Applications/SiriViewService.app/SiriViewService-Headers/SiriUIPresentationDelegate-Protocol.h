...
- (void)siriPresentation:(id <SiriUIPresentation>)arg1 conversationDidLoad:(NSUUID *)arg2;
- (void)siriPresentation:(id <SiriUIPresentation>)arg1 conversationWillLoad:(NSUUID *)arg2;
