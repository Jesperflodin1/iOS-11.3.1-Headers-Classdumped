...
@interface TabOverview : UIView <CloudTabTableDelegate, _UIBasicAnimationFactory, UIGestureRecognizerDelegate, UISearchBarDelegate, UISearchBarDelegate_Private, UIKeyInput, TabSnapshotSizing>
{
...
+ (struct CGSize)_maximumiPadDimensionsForStandardTabOverviewColumns;
...
- (unsigned long long)_layoutIndexForItemIndex:(unsigned long long)arg1 ofItems:(id)arg2;
