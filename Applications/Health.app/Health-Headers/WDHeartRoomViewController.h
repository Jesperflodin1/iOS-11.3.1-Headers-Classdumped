...
@property(nonatomic) NSDate *displayDate; // @synthesize displayDate=_displayDate;
...
@property(retain, nonatomic) NSDateInterval *currentHeartChartDateInterval; // @synthesize currentHeartChartDateInterval=_currentHeartChartDateInterval;
...
@property(retain, nonatomic) NSUUID *heartRateQueryUUID; // @synthesize heartRateQueryUUID=_heartRateQueryUUID;
