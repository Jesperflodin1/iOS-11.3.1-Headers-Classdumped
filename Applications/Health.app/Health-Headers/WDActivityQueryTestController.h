...
@class NSString, WDPortraitActivitySummaryChartDataProvider, WDProfile;

@interface WDActivityQueryTestController : NSObject <WDActivitySummaryDataProviderObserver>
{
    WDProfile *_profile;
    WDPortraitActivitySummaryChartDataProvider *_provider;
}

@property(retain, nonatomic) WDPortraitActivitySummaryChartDataProvider *provider; // @synthesize provider=_provider;
