...
@class NSMapTable, NSString, WDActivitySummaryAnnotationViewDataSource, WDPortraitActivitySummaryChartDataProvider;
...
@interface WDInteractiveChartActivityController : WDInteractiveChartViewController <WDInteractiveChartViewObserver, WDActivityBarSeriesDelegate, HKAxisAccessoryViewDelegate>
{
    ...
    WDPortraitActivitySummaryChartDataProvider *_activityDataProvider;
...
@property(retain, nonatomic) WDPortraitActivitySummaryChartDataProvider *activityDataProvider; // @synthesize activityDataProvider=_activityDataProvider;
