...
@class HKGraphSeries, NSString, UIColor, WDInteractiveChartDataFormatter;
...
@interface WDInteractiveChartDisplayType : HKDisplayType
{
    ...
    WDInteractiveChartDataFormatter *_specifiedValueFormatter;
}

@property(readonly, nonatomic) WDInteractiveChartDataFormatter *specifiedValueFormatter; // @synthesize specifiedValueFormatter=_specifiedValueFormatter;
