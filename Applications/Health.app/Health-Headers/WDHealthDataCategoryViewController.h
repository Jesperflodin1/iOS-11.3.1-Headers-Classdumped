...
@interface WDHealthDataCategoryViewController : HKViewController <HKCurrentTimeViewDelegate, HKDateCacheObserver, UITableViewDataSource, UITableViewDelegate, SKStoreProductViewControllerDelegate, WDAppSwooshTableViewCellDelegate, WDCurrentValueTableViewCellDelegate, WDFavoriteDisplayTypesControllerObserver, WDInteractiveChartViewObserver, WDTodayMonthViewControllerDelegate, WDSampleTypeDateRangeControllerObserver, WDUserActivityResponder>
{
