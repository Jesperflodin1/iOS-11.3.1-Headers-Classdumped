...
@class HKUIMetricColors, NSArray, NSDateComponents, NSString, UIFont, UILabel, UIStackView, WDSelectedRangeFormatter;

@interface WDInteractiveChartAnnotationViewDataSource : NSObject <WDInteractiveChartAnnotationViewDataSource>
{
...
@property(readonly, nonatomic) WDSelectedRangeFormatter *selectedRangeFormatter; // @synthesize selectedRangeFormatter=_selectedRangeFormatter;
- (void).cxx_destruct;
