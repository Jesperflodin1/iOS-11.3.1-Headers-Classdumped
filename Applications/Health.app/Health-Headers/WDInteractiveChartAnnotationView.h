...
@interface WDInteractiveChartAnnotationView : UIView
{
    _Bool _showSeparators;
    id <WDInteractiveChartAnnotationViewDataSource> _dataSource;
...
@property(nonatomic) __weak id <WDInteractiveChartAnnotationViewDataSource> dataSource; // @synthesize dataSource=_dataSource;
- (void).cxx_destruct;
