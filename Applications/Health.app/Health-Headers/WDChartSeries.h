...
- (double)_getYValueForPointFromChartPointValue:(id)arg1 inverted:(_Bool)arg2;
- (double)getYValueForPointFromChartPointValue:(id)arg1;
- (double)getXValueForPointFromChartPoint:(id)arg1;
- (double)_relativePositionForXPlaneValue:(id)arg1;
- (_Bool)shouldInvertAxis;
- (_Bool)yValueIsClamped:(id)arg1;
