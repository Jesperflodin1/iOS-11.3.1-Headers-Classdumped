...
* Image Source: /System/Library/Accounts/DataclassOwners/MessagesDataclassOwner.bundle/MessagesDataclassOwner
* classdump-dyld is licensed under GPLv3, Copyright © 2013-2016 by Elias Limneos.
*/

#import <MessagesDataclassOwner/ACDDataclassOwnerProtocol.h>

@class NSString;

@interface CKiCloudSettingsPlugin : NSObject <ACDDataclassOwnerProtocol>
...
+(id)dataclasses;
-(BOOL)setCloudEnable:(BOOL)arg1 ;
-(BOOL)promptUserIfTheyWantToDisableOrCancel;
-(BOOL)checkEligibilityWithError:(id*)arg1 ;
-(BOOL)purchasedMaxQuotaTier;
-(void)setEnabledDidReturned:(id)arg1 ;
-(void)didPerformAdditionalStorageRequiredCheck:(id)arg1 ;
