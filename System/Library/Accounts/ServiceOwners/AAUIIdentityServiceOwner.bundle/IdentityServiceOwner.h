...
* Image Source: /System/Library/Accounts/ServiceOwners/AAUIIdentityServiceOwner.bundle/AAUIIdentityServiceOwner
...
@interface IdentityServiceOwner : NSObject <AIDAServiceOwnerProtocol> {

	ACAccountStore* _accountStore;
	NSDictionary* _accountControllers;
...
+(BOOL)_once_hasIDSMachException;
+(BOOL)_once_hasNoSandboxEntitlement;
+(BOOL)_hasIDSMachException;
+(BOOL)_hasNoSandboxEntitlement;
+(id)supportedServices;
-(id)_accountControllerForService:(id)arg1 ;
-(id)_activeIDSAccountForService:(id)arg1 ;
-(id)_identityServicesAccountType;
