...
* Image Source: /System/Library/Accounts/ServiceOwners/AAUIStoreServiceOwner.bundle/AAUIStoreServiceOwner
...
@interface StoreServiceOwner : NSObject <AIDAServiceOwnerProtocol> {
