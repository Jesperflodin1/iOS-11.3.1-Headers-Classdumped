...
#import <ActivitySharingPlugin/ASIDSMessageCenterDelegate.h>
#import <ActivitySharingPlugin/ASBBDataProviderDelegate.h>
#import <ActivitySharingPlugin/ASCloudKitManagerChangesObserver.h>
#import <ActivitySharingPlugin/ASGatewayManagerChangesObserver.h>
#import <ActivitySharingPlugin/ASActivitySharingManagerReadyObserver.h>

@protocol OS_dispatch_queue;
@class ASActivityDataManager, HDFitnessAppBadgeManager, ASCloudKitManager, ASContactsManager, ASFriendListManager, ASGatewayManager, NSDictionary, ASInvitationBBDataProvider, CNContactStore, NSObject, NSMutableDictionary, NSString;

@interface ASRelationshipManager : NSObject <ASIDSMessageCenterDelegate, ASBBDataProviderDelegate, ASCloudKitManagerChangesObserver, ASGatewayManagerChangesObserver, ASActivitySharingManagerReadyObserver> {
	...
	ASInvitationBBDataProvider* _bulletinBoardInvitationDataProvider;
