...
@class ASActivitySharingManager, NSObject, APSConnection, CKShare, NSHashTable, ASNotificationStep, NSArray, ASCloudKitServerChangeTokenCache, NSDictionary, ASCloudKitUtility, CKContainer, NSDate, NSString;
