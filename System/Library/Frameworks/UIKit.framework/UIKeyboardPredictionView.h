...
@class UIKBBackgroundView, UIKeyboardPredictionBarGrabber, NSArray, NSMutableArray, UIKeyboardPredictionCell, NSString, UIView, UILabel, UIKBKeyView, LAContext, UITouch, TIKeyboardCandidate, NSTimer, NSDate;
