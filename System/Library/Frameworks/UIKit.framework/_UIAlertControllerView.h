...
@class UIAlertController, UIAlertControllerVisualStyle, UIView, _UIAlertControllerInterfaceActionGroupView, UILabel, _UIKeyboardLayoutAlignmentView, NSMutableArray, NSArray, UIAlertAction, _UIAlertControllerActionViewMetrics, NSLayoutConstraint, _UIFlexibleConstantConstraintSet, NSString;
