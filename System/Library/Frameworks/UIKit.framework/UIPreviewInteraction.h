...
@class UIView, _UIPreviewInteractionStateRecognizer, CADisplayLink, _UIDeepPressAnalyzer, _UIStatesFeedbackGenerator, _UIPreviewInteractionHighlighter, _UIPreviewInteractionViewControllerHelper, NSHashTable;
