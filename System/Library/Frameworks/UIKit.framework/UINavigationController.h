...
@interface UINavigationController : UIViewController <UIGestureRecognizerDelegatePrivate, _UINavigationBarDelegatePrivate, _UIScrollViewScrollObserver, UILayoutContainerViewDelegate> {
	...
	CGPoint _interactiveScrollNavBarIntrinsicHeightRange;
...
-(SCD_Struct_UI37)_calculateTopLayoutInfoForViewController:(id)arg1 ;
...
-(CGPoint)_intrinsicNavigationBarHeightRangeForViewController:(id)arg1 ;
