...
@class _UIButtonBarStackView, UILayoutGuide, NSLayoutConstraint, UIView, _UIButtonBarLayoutMetrics, NSMutableArray, NSMapTable, NSArray, _UIButtonBarButtonVisualProvider, UIBarButtonItem, NSString;
