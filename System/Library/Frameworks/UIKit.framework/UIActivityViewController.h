...
@class NSArray, _UIShareExtensionRemoteViewController, NSExtension, UISUIActivityViewControllerConfiguration, NSMutableDictionary, _UIActivityHelper, UIAlertController, _UIAlertControllerShimPresenter, UIAlertAction, NSOperationQueue, NSString, UIActivity, UIViewController;
...
@property (assign,setter=_setBeginShareUIConnectionTimestamp:,getter=_beginShareUIConnectionTimestamp,nonatomic) unsigned long long beginShareUIConnectionTimestamp;                 //@synthesize beginShareUIConnectionTimestamp=_beginShareUIConnectionTimestamp - In the implementation block
...
@property (assign,setter=_setPresentationWasDelayed:,getter=_presentationWasDelayed,nonatomic) BOOL presentationWasDelayed;                                                          //@synthesize presentationWasDelayed=_presentationWasDelayed - In the implementation block
