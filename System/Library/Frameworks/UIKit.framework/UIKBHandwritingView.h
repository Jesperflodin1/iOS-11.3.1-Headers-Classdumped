...
@interface UIKBHandwritingView : UIKBKeyView <UIGestureRecognizerDelegate> {
	...
	SCD_Struct_UI67 _previousPoint;
...
@property (assign,nonatomic) SCD_Struct_UI78 previousPoint;                                      //@synthesize previousPoint=_previousPoint - In the implementation block
...
-(void)setPreviousPoint:(SCD_Struct_UI78)arg1 ;
-(BOOL)initialPointPosted;
-(SCD_Struct_UI78)previousPoint;
