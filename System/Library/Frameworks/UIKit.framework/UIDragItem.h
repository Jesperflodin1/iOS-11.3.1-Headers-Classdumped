...
@class _UIDraggingItem, _UIDragSessionImpl, NSItemProvider, _UIInternalDraggingItem, _UIDragPreviewProvider, UITargetedDragPreview, UITextRange;
...
@property (setter=_setInternalDraggingItem:,getter=_internalDraggingItem,nonatomic,retain) _UIInternalDraggingItem * internalDraggingItem;                         //@synthesize internalDraggingItem=_internalDraggingItem - In the implementation block
