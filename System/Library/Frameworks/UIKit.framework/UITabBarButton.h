...
@class UITabBarSwappableImageView, UIVisualEffectView, UITabBarButtonLabel, _UIBadgeView, UIImageView, UIImage, NSMutableDictionary, UIColor, UITabBar, NSString;
