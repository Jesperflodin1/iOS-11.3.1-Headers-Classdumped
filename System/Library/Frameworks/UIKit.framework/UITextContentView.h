...
@class WebFrame, DOMHTMLElement, UITextInteractionAssistant, UIWebDocumentView, UIFont, UIColor, UIDragInteraction, UIDropInteraction, NSString, NSAttributedString, UITextRange, NSDictionary, UITextPosition, UIView;
