...
@interface _UIFlowLayoutInfo : NSObject {
	...
	SCD_Struct_UI107 _rowAlignmentOptions;
	CGSize _contentSize;
...
@property (assign,nonatomic) SCD_Struct_UI107 rowAlignmentOptions;                    //@synthesize rowAlignmentOptions=_rowAlignmentOptions - In the implementation block
