...
-(id)allDataTypes;
-(void)prepareForSendingToExtension:(id)arg1 readyBlock:(/*^block*/id)arg2 ;
-(void)prepareForSendingAsCompletionWithExtensionContext:(id)arg1 readyBlock:(/*^block*/id)arg2 ;
