...
@class PDFAnnotationPrivateVars, UIFont, UIColor, NSArray, NSString, PDFDestination, NSURL, PDFPage, NSDate, PDFAnnotationPopup, PDFBorder, PDFAction, NSDictionary;
