...
@class CNContactNavigationController, CNContactStoreDataSource, NSMutableArray, NSArray, NSString, NSPredicate, CNManagedConfiguration, UINavigationController;
