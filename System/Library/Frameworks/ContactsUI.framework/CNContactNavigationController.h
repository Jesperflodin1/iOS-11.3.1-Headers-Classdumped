...
@class CNContactListViewController, CNContactStyle, CNContactStore, CNContactViewController, CNAccountsAndGroupsDataSource, CNContactStoreDataSource, UIKeyCommand, UIAlertController, NSString;
