...
@class CNContactStoreSnapshot, NSDictionary, NSObject, CNContactFormatter, CNContactStoreFilter, CNContactStore, CNManagedConfiguration, NSArray, CNContact, CNiOSAddressBook, NSString, CNContactFilter;
...
@property (nonatomic,readonly) CGRect screenFrame;                                                         //@synthesize screenFrame=_screenFrame - In the implementation block
