...
@class AVOutputDevice, AVWeakReference, NSString, NSData, NSNumber, NSArray;
...
-(id)initWithFigEndpoint:(OpaqueFigEndpointRef)arg1 volumeController:(OpaqueFigVolumeControllerStateRef)arg2 routingContextFactory:(id)arg3 ;
