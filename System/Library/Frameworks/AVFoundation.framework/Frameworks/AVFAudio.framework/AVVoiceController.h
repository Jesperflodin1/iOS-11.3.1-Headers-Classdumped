...
@class NSString, NSDictionary, AVAudioFormat, NSXPCConnection;
...
@property (retain,readonly) NSXPCConnection * voiceTriggerServerConnection; 
@property (assign) id<AVVoiceControllerVoiceTriggerDelegate> voiceTriggerDelegate; 
...
-(void)avAudioPCMRecordBufferListReceived:(AudioBufferList*)arg1 atTime:(unsigned long long)arg2 ;
...
-(id<AVVoiceControllerVoiceTriggerDelegate>)voiceTriggerDelegate;
-(void)setVoiceTriggerDelegate:(id<AVVoiceControllerVoiceTriggerDelegate>)arg1 ;
