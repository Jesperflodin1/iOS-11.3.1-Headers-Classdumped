...
@class AVWeakReference, AVOutputDevice, NSString, NSData, NSNumber, NSArray;
...
-(id)initWithRouteDescriptor:(CFDictionaryRef)arg1 routeDiscoverer:(OpaqueFigRouteDiscovererRef)arg2 volumeController:(OpaqueFigVolumeControllerStateRef)arg3 routingContextFactory:(id)arg4 ;
