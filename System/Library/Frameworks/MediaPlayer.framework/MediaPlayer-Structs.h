...
typedef struct {
	...
	SCD_Struct_MP13 artist;
	SCD_Struct_MP13 genre;
} SCD_Struct_MP14;
...
typedef struct {
	unsigned initialized : 1;
	unsigned title : 1;
	unsigned shortTitle : 1;
	unsigned editorNotes : 1;
	unsigned shortEditorNotes : 1;
	unsigned editorialArtwork : 1;
	unsigned artwork : 1;
	unsigned episodeCount : 1;
	unsigned tagline : 1;
} SCD_Struct_MP16;
...
typedef struct {
	...
	unsigned shouldExcludeFromShuffle : 1;
	unsigned volumeNormalization : 1;
	unsigned year : 1;
	...
	SCD_Struct_MP13 artist;
	SCD_Struct_MP13 composer;
	SCD_Struct_MP13 genre;
	SCD_Struct_MP39 homeSharingAsset;
	SCD_Struct_MP40 lyrics;
} SCD_Struct_MP41;
...
typedef struct {
	...
	unsigned libraryAdded : 1;
	unsigned libraryAddEligible : 1;
	unsigned shouldExcludeFromShuffle;
	unsigned shouldShowComposer : 1;
	unsigned volumeNormalization : 1;
	unsigned year : 1;
	unsigned userRating : 1;
