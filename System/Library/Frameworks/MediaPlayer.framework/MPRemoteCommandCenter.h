...
@class NSMutableArray, NSObject, MPRemoteCommand, MPSkipIntervalCommand, MPRatingCommand, MPChangePlaybackRateCommand, MPFeedbackCommand, MPChangePlaybackPositionCommand, MPChangeRepeatModeCommand, MPChangeShuffleModeCommand, MPPurchaseCommand, MPAdvanceShuffleModeCommand, MPAdvanceRepeatModeCommand, MPSetPlaybackQueueCommand, MPInsertIntoPlaybackQueueCommand, MPReorderQueueCommand, MPChangePlaybackProgressCommand, NSString, NSArray;
...
-(const CFArrayRef)_copySupportedCommands;
