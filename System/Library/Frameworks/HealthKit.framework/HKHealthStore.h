...
@protocol OS_dispatch_queue, HDHealthStoreServerInterface, _HKAuthorizationPresentationController;
...
-(void)_beginWorkoutWithActivityType:(unsigned long long)arg1 startDate:(id)arg2 goalType:(unsigned long long)arg3 goal:(id)arg4 metadata:(id)arg5 lapLength:(id)arg6 shouldUseDeviceData:(BOOL)arg7 fitnessMachineSessionConfiguration:(id)arg8 completion:(/*^block*/id)arg9 ;
-(void)_reattachWorkout:(id)arg1 fitnessMachineConnection:(id)arg2 fitnessMachineSessionConfiguration:(id)arg3 willReactivate:(BOOL)arg4 completion:(/*^block*/id)arg5 ;
...
-(void)_startWorkoutSession:(id)arg1 completion:(/*^block*/id)arg2 ;
-(BOOL)_addWorkoutSession:(id)arg1 ;
-(void)_removeWorkoutSession:(id)arg1 ;
-(void)_endWorkoutSession:(id)arg1 completion:(/*^block*/id)arg2 ;
-(void)_pauseWorkoutSession:(id)arg1 completion:(/*^block*/id)arg2 ;
-(void)_resumeWorkoutSession:(id)arg1 completion:(/*^block*/id)arg2 ;
...
-(void)_reattachWorkout:(id)arg1 fitnessMachineConnection:(id)arg2 fitnessMachineSessionConfiguration:(id)arg3 completion:(/*^block*/id)arg4 ;
-(void)_pauseAllActiveWorkoutsWithCompletion:(/*^block*/id)arg1 ;
-(void)_saveActiveWorkout:(id)arg1 isMachineWorkout:(BOOL)arg2 completion:(/*^block*/id)arg3 ;
...
-(void)saveWorkoutRouteData:(id)arg1 withRoute:(id)arg2 completion:(/*^block*/id)arg3 ;
-(void)finishWorkoutRoute:(id)arg1 workout:(id)arg2 metadata:(id)arg3 completion:(/*^block*/id)arg4 ;
-(void)discardWorkoutRoute:(id)arg1 completion:(/*^block*/id)arg2 ;
