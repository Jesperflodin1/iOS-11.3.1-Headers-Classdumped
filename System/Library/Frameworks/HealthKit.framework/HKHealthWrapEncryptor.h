...
-(void)dealloc;
-(id)initWithOutputStream:(id)arg1 certificate:(SecCertificateRef)arg2 algorithm:(unsigned)arg3 options:(unsigned)arg4 keySize:(unsigned)arg5 uuid:(id)arg6 studyUUID:(id)arg7 ;
