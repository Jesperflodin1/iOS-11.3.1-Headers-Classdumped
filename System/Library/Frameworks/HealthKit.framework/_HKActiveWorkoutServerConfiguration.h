...
@property (nonatomic,retain) NSUUID * fitnessMachineSessionID;                    //@synthesize fitnessMachineSessionID=_fitnessMachineSessionID - In the implementation block
@property (nonatomic,retain) HKQuantity * initialActiveEnergyBurned;              //@synthesize initialActiveEnergyBurned=_initialActiveEnergyBurned - In the implementation block
@property (nonatomic,retain) HKQuantity * initialBasalEnergyBurned;               //@synthesize initialBasalEnergyBurned=_initialBasalEnergyBurned - In the implementation block
...
-(void)setInitialActiveEnergyBurned:(HKQuantity *)arg1 ;
-(void)setInitialBasalEnergyBurned:(HKQuantity *)arg1 ;
...
-(HKQuantity *)initialActiveEnergyBurned;
-(HKQuantity *)initialBasalEnergyBurned;
