...
-(SCD_Struct_MT17)libraryCacheStats;
-(SCD_Struct_MT17)pipelineCacheStats;
...
-(id)newLibraryWithCIFilters:(id)arg1 imageFilterFunctionInfo:(const SCD_Struct_MT18*)arg2 error:(id*)arg3 ;
...
-(SCD_Struct_MT19)pipelineFlagsWithVertexVariant:(id)arg1 fragmentVariant:(id)arg2 ;
-(SCD_Struct_MT20)pipelineFlagsWithComputeVariant:(NSObject*)arg1 ;
...
-(id)newComputePipelineStateWithImageFilterFunctionsSPI:(id)arg1 imageFilterFunctionInfo:(const SCD_Struct_MT18*)arg2 error:(id*)arg3 ;
