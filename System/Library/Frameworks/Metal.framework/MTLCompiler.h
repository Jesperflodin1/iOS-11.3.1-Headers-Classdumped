...
-(void)compileFunction:(id)arg1 frameworkData:(id)arg2 driverKeyData:(id)arg3 frameworkLinking:(BOOL)arg4 linkDataSize:(unsigned long long)arg5 pipelineCache:(id)arg6 options:(unsigned)arg7 completionHandler:(/*^block*/id)arg8 ;
...
-(id)initWithTargetData:(id)arg1 cacheUUID:(SCD_Struct_MT44*)arg2 pluginPath:(id)arg3 device:(id)arg4 compilerFlags:(unsigned long long)arg5 ;
