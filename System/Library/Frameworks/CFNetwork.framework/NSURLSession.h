...
-(void)delegate_AVAssetDownloadTask:(id)arg1 didLoadTimeRange:(SCD_Struct_NS28)arg2 totalTimeRangesLoaded:(id)arg3 timeRangeExpectedToLoad:(SCD_Struct_NS28)arg4 ;
...
-(void)delegate_AVAggregateAssetDownloadTask:(id)arg1 didLoadTimeRange:(SCD_Struct_NS28)arg2 totalTimeRangesLoaded:(id)arg3 timeRangeExpectedToLoad:(SCD_Struct_NS28)arg4 forMediaSelection:(id)arg5 ;
