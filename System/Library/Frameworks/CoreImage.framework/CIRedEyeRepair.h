...
@interface CIRedEyeRepair : NSObject {
	...
	BOOL forceLoValue;
	int loValue;
	SCD_Struct_CI34 lastClickYBitmap;
	SCD_Struct_CI34 lastClickCbCrBitmap;
	int lastClickBitmapMinX;
	int lastClickBitmapMaxX;
	int lastClickBitmapMinY;
	int lastClickBitmapMaxY;
	SCD_Struct_CI34 lastClickYBitmaps[3];
	SCD_Struct_CI34 lastClickCbCrBitmaps[3];
	GridROI_t lastClickBitmapRects[3];
	SCD_Struct_CI34 lastSearchYBitmap;
	SCD_Struct_CI34 lastSearchCbCrBitmap;
...
-(BOOL)getBlockSetWithImage:(CGImageRef)arg1 into:(SCD_Struct_CI34*)arg2 width:(unsigned long long)arg3 height:(unsigned long long)arg4 ;
-(BOOL)getDataProviderBytePtrWithImage:(CGImageRef)arg1 into:(SCD_Struct_CI34*)arg2 width:(unsigned long long)arg3 height:(unsigned long long)arg4 ;
-(BOOL)getDataProviderCopyWithImage:(CGImageRef)arg1 into:(SCD_Struct_CI34*)arg2 ;
-(id)initWithDeskView:(id)arg1 andFrame:(SCD_Struct_CI40*)arg2 ;
-(void)skinInit;
-(void)initializeNonDebugVariables;
-(id)initWithFrameExternalBuffer:(SCD_Struct_CI40*)arg1 ;
-(SCD_Struct_CI41*)repairWithTag:(int)arg1 ;
...
-(BOOL)extractReusableAlignedBitmapsAroundPoint:(SCD_Struct_CI34*)arg1 YR:(GridROI_t)arg2 subYBitmap:(SCD_Struct_CI34*)arg3 subCbCrBitmap:(SCD_Struct_CI34*)arg4 ;
-(int)averageValueFromY:(SCD_Struct_CI34*)arg1 withinSkinMask:(SCD_Struct_CI34*)arg2 butOutsideAlpha:(SCD_Struct_CI34*)arg3 ;
-(BOOL)computeTrimmedBitmaps:(SCD_Struct_CI34*)arg1 newY:(SCD_Struct_CI34*)arg2 newCbCr:(SCD_Struct_CI34*)arg3 IR:(GridROI_t)arg4 newTrimY:(SCD_Struct_CI34*)arg5 newTrimCbCr:(SCD_Struct_CI34*)arg6 returningYR:(GridROI_t*)arg7 andCbCrR:(GridROI_t*)arg8 ;
...
-(void)insertIntoProminenceVettingHopper:(SCD_Struct_CI43*)arg1 max:(int)arg2 outside:(int)arg3 confidence:(float)arg4 distance:(float)arg5 row:(int)arg6 column:(int)arg7 IOD:(float)arg8 ;
-(BOOL)gatherProminencesWithC:(SCD_Struct_CI34*)arg1 MC:(SCD_Struct_CI34*)arg2 altC:(SCD_Struct_CI34*)arg3 altMC:(SCD_Struct_CI34*)arg4 maxwindowsize:(int)arg5 repairsize:(int)arg6 IR:(GridROI_t)arg7 fr:(SCD_Struct_CI44*)arg8 intoHopper:(SCD_Struct_CI43*)arg9 faceIndex:(int)arg10 left:(BOOL)arg11 ;
-(float)extractAverageFaceY:(SCD_Struct_CI44*)arg1 contrast:(float*)arg2 faceIndex:(int)arg3 ;
...
-(void)autoRepairExtractAndSearchLeft:(GridROI_t)arg1 right:(GridROI_t)arg2 data:(SCD_Struct_CI44*)arg3 repairSize:(float)arg4 autoPupilTonality:(BOOL)arg5 faceIndex:(int)arg6 ;
...
-(int)redEyeRemovalWithData:(SCD_Struct_CI45)arg1 ;
