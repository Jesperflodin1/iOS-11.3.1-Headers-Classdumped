...
@interface CIBilateralSolverGPU : NSObject {
	...
	SCD_Struct_CI53 _threadGroupInfo;
	SCD_Struct_CI54 _params;
	MetalFaceMaskCubeInputScaling_t _offsets;
	int _width;
	int _height;
...
-(int)doSolveWithBilateralGridhash:(id)arg1 reference:(id)arg2 disparity:(id)arg3 confidence:(id)arg4 output:(id)arg5 lambda:(float)arg6 maxIterations:(int)arg7 offsets:(MetalFaceMaskCubeInputScaling_t*)arg8 ;
