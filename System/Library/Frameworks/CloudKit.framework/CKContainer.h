...
@class NSString, CKContainerID, CKRecordID, CKContainerOptions, CKDatabase, NSXPCConnection, NSOperationQueue, CKOperationCallbackManager, CKOperationFlowControlManager, ACAccountStore, NSMutableArray, CKContainerSetupInfo, NSMapTable, NSMutableDictionary, CKAccountOverrideInfo;
