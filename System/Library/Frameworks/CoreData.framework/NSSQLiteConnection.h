...
@class NSObject, NSSQLCore, NSURL, NSString, NSSQLiteStatement, NSArray, NSSQLEntity, NSMutableSet, NSMutableDictionary, NSMutableArray, NSSQLitePrefetchRequestCache;
