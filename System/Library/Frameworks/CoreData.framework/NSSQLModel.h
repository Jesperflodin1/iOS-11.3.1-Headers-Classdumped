...
-(id)initWithManagedObjectModel:(id)arg1 configurationName:(id)arg2 entityIDOffset:(unsigned)arg3 ;
...
-(id)initWithManagedObjectModel:(id)arg1 configurationName:(id)arg2 retainHashHack:(BOOL)arg3 brokenHashVersion:(unsigned long long)arg4 entityIDOffset:(unsigned)arg5 ;
