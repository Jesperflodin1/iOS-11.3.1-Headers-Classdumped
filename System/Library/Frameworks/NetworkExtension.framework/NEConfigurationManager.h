...
@interface NEConfigurationManager : NSObject {
	...
	/*^block*/id _getIndexDelegateCallback;
...
@property (copy) id getIndexDelegateCallback;                                                 //@synthesize getIndexDelegateCallback=_getIndexDelegateCallback - In the implementation block
...
-(void)setGetIndexDelegateCallback:(id)arg1 ;
-(NEHelper *)helper;
