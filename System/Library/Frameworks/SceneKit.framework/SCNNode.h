...
@interface SCNNode : NSObject <NSCopying, NSSecureCoding, SCNAnimatable, SCNActionable, SCNBoundingVolume, UIFocusItem> {
	...
	SCD_Struct_SC12 _transform;
	 _position;
	SCD_Union_SC87 _rotation;
	 _scale;
	float _opacity;
...
@property (assign,nonatomic) SCD_Struct_SC12 simdTransform; 
@property (assign,nonatomic)  simdPosition; 
@property (assign,nonatomic)  simdRotation; 
@property (assign,nonatomic) SCD_Struct_SC69 simdOrientation; 
@property (assign,nonatomic)  simdEulerAngles; 
@property (assign,nonatomic)  simdScale; 
@property (assign,nonatomic) SCD_Struct_SC12 simdPivot; 
@property (assign,nonatomic)  simdWorldPosition; 
@property (assign,nonatomic) SCD_Struct_SC69 simdWorldOrientation; 
@property (assign,nonatomic) SCD_Struct_SC12 simdWorldTransform; 
...
-(void)simdLocalRotateBy:(SCD_Struct_SC69)arg1 ;
-(SCD_Struct_SC12)simdWorldTransform;
-()simdWorldPosition;
-(4)simdConvertVector:(id)arg1 ;
-(SCD_Struct_SC69)simdWorldOrientation;
-()simdWorldFront;
-(void)setSimdWorldOrientation:(SCD_Struct_SC69)arg1 ;
-(void)setSimdPosition:;
-(SCD_Struct_SC69)simdOrientation;
-(void)setSimdOrientation:(SCD_Struct_SC69)arg1 ;
-()simdWorldRight;
-(4)simdConvertPosition:(id)arg1 ;
-(4)simdConvertVector:(id)arg1 ;
-()simdWorldUp;
-(void)setSimdWorldTransform:(SCD_Struct_SC12)arg1 ;
-(void)simdRotateBy:(SCD_Struct_SC69)arg1 ;
-(SCNVector3)worldUp;
...
-(void)setSimdTransform:(SCD_Struct_SC12)arg1 ;
-(SCD_Struct_SC12)simdTransform;
-(void)setSimdWorldPosition:;
-(void)setSimdPivot:(SCD_Struct_SC12)arg1 ;
-(SCD_Struct_SC12)simdPivot;
...
-(id)_particleSystems;
-(id)_audioPlayers;
-(SCD_Struct_SC12)simdConvertTransform:(SCD_Struct_SC12)arg1 toNode:(id)arg2 ;
-(SCD_Struct_SC12)simdConvertTransform:(SCD_Struct_SC12)arg1 fromNode:(id)arg2 ;
...
-(void)_setQuaternion:(SCD_Struct_SC69)arg1 ;
-(1)_euler;
