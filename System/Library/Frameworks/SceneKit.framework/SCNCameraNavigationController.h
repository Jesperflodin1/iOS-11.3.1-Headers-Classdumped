...
@interface SCNCameraNavigationController : NSObject <SCNEventHandler, SCNCameraControllerDelegate> {
	...
	SCD_Union_SC122 _sceneBoundingSphere;
	 _translationOrigin;
	float _initialZoom;
	...
	SCD_Struct_SC123 _stickyAxis;
	SCD_Struct_SC124 _target;
	SCD_Struct_SC125 _inertia;
	SCD_Struct_SC133* _keyboard;
	SCD_Struct_SC124 _scrollWheelModifiers;
