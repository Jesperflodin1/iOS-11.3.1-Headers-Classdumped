...
@interface SCNCameraController : NSObject {
	...
	SCD_Struct_SC70 _orientationState;
	SCD_Struct_SC69 _inputLocation;
	SCD_Struct_SC69 _arcball;
	SCD_Struct_SC71 _inertia;
	 _up;
	 _target;
	 _minimumAngles;
	 _maximumAngles;
...
-(SCD_Struct_SC69)unrolledWorldOrientation:(out float*)arg1 ;
...
-(SCD_Struct_SC69)_orientationForMode;
-(SCD_Struct_SC69)_convertRotationFromWorldToPointOfView:(SCD_Struct_SC69)arg1 ;
...
-(SCD_Struct_SC12)lookAtWith:target:;
