...
@class NSURL, NSNumber, NSString, NSDate, NSData, NSError, NSPersonNameComponents, NSDictionary, NSProgress, NSArray, FPItemID;
...
@property (nonatomic,copy) NSData * tagData;                                                                     //@synthesize tagData=_tagData - In the implementation block
