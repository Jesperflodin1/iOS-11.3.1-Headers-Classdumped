...
@class MKMapViewInternal, UIView, MKMapAnnotationManager, MKAnnotationContainerView, MKAttributionLabel, UIImageView, NSTimer, MKDebugLocationConsole, _MKEnvironmentLabel, UILongPressGestureRecognizer, UITapGestureRecognizer, UIGestureRecognizer, MKMapGestureController, MKOverlayContainerView, MKBasicMapView, VKMapView, VKLabelMarker, MKScaleView, MKCompassView, MKUserLocation, VKRouteContext, VKNavContext, MKMapCamera, UITextView, UIPanGestureRecognizer, UILayoutGuide, NSLayoutConstraint, _MKCustomFeatureStore, MKMapViewLabelMarkerState, CLLocation, MKAnnotationView, NSArray, NSString, NSDictionary, GEOResourceManifestConfiguration, GEOMapRegion, UIPopoverController, UIPinchGestureRecognizer, UIRotationGestureRecognizer, VKVenueFeatureMarker, VKVenueBuildingFeatureMarker;
...
@interface MKMapView : UIView <MKOverlayContainerViewDelegate, MKAnnotationContainerViewDelegate, VKMapViewDelegate, MKMapGestureControllerDelegate, MKAnnotationMarkerContainer, MKAnnotationManagerDelegate, GEOLogContextDelegate, UIGestureRecognizerDelegate, MKVariableDelayTapRecognizerDelegate, GEOResourceManifestTileGroupObserver, NSCoding> {
	...
	struct {
		...
		unsigned useSafeAreaInsets : 1;
		unsigned useLayoutGuideInsets : 1;
...
@property (assign,nonatomic) SCD_Struct_MK5 region; 
...
+(SCD_Struct_MK5)regionThatFitsMapType:(unsigned long long)arg1 viewSize:(CGSize)arg2 edgeInsets:(UIEdgeInsets)arg3 region:(SCD_Struct_MK5)arg4 ;
+(SCD_Struct_MK5)regionThatFitsMapType:(unsigned long long)arg1 viewSize:(CGSize)arg2 region:(SCD_Struct_MK5)arg3 ;
...
+(SCD_Struct_MK5)_regionThatFitsMapType:(unsigned long long)arg1 viewSize:(CGSize)arg2 viewInsets:(UIEdgeInsets)arg3 edgePadding:(UIEdgeInsets)arg4 region:(SCD_Struct_MK5)arg5 minZoomLevel:(double)arg6 maxZoomLevel:(double)arg7 snapToZoomLevel:(BOOL)arg8 ;
...
-(CGRect)convertRegion:(SCD_Struct_MK5)arg1 toRectToView:(id)arg2 ;
-(SCD_Struct_MK5)convertRect:(CGRect)arg1 toRegionFromView:(id)arg2 ;
...
-(SCD_Struct_MK6)_zoomRegionForMapRect:(SCD_Struct_MK1)arg1 edgePadding:(UIEdgeInsets)arg2 maxZoomLevel:(long long)arg3 minZoomLevel:(long long)arg4 ;
-(SCD_Struct_MK5)regionThatFits:(SCD_Struct_MK5)arg1 ;
...
-(double)_zoomLevelForRegion:(SCD_Struct_MK5)arg1 includeAccessoryPadding:(BOOL)arg2 ;
...
-(multimap<unsigned int, std::__1::vector<URS::RouteShare, std::__1::allocator<URS::RouteShare> >, std::__1::less<unsigned int>, std::__1::allocator<std::__1::pair<const unsigned int, std::__1::vector<URS::RouteShare, std::__1::allocator<URS::RouteShare> > > > >*)_shareSectionsForRoutes:(id)arg1 ;
...
-(CGRect)_convertRegion:(SCD_Struct_MK5)arg1 toRectToView:(id)arg2 ;
-(SCD_Struct_MK5)_convertRect:(CGRect)arg1 toRegionFromView:(id)arg2 ;
-(double)_distanceFromPoint:(CGPoint)arg1 toPoint:(CGPoint)arg2 fromView:(id)arg3 withPrecision:(long long)arg4 ;
-(BOOL)isPitchEnabled;
-(void)setRegion:(SCD_Struct_MK5)arg1 animated:(BOOL)arg2 ;
