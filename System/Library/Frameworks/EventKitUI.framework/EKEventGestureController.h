...
@class UILongPressGestureRecognizer, UITapGestureRecognizer, EKDayOccurrenceView, EKEvent, EKCalendarDate, NSTimer, EKICSPreviewController, EKUIRecurrenceAlertController, _UIFeedbackDragSnappingBehavior, UIDropInteraction, UIDragInteraction, NSString;
