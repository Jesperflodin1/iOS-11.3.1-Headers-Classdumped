...
@class UITextInteractionAssistant, UITextRange, NSDictionary, UITextPosition, UIView, UITextInputTraits, _UITextFieldRoundedRectBackgroundViewNeue, UIScrollView, _MFAtomFieldEditor, UILabel, UIButton, NSMutableArray, _MFAtomTextViewBaselineLayoutStrut, NSLayoutConstraint, UIFont, UIColor, NSString, NSArray, NSIndexSet, UIImage, UIInputContextHistory;
