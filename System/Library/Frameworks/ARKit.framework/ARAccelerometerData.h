...
@interface ARAccelerometerData : NSObject <ARMutableSensorData, NSSecureCoding> {
	...
	double _timestamp;
	double _temperature;
	SCD_Struct_AR34 _acceleration;

}

@property (assign,nonatomic) SCD_Struct_AR34 acceleration;              //@synthesize acceleration=_acceleration - In the implementation block
...
-(SCD_Struct_AR34)acceleration;
-(double)temperature;
-(void)setAcceleration:(SCD_Struct_AR34)arg1 ;
@end
