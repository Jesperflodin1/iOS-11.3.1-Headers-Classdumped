...
+(BOOL)canReadURL:(id)arg1 fromSandboxWithAuditToken:(const SCD_Struct_LS8*)arg2 ;
+(BOOL)canWriteURL:(id)arg1 fromSandboxWithAuditToken:(const SCD_Struct_LS8*)arg2 ;
+(BOOL)canReadMetadataOfURL:(id)arg1 fromSandboxWithAuditToken:(const SCD_Struct_LS8*)arg2 ;
+(BOOL)canAccessURL:(id)arg1 fromSandboxWithAuditToken:(const SCD_Struct_LS8*)arg2 operation:(const char*)arg3 ;
...
-(BOOL)canReadFromSandboxWithAuditToken:(const SCD_Struct_LS8*)arg1 ;
...
-(BOOL)canWriteFromSandboxWithAuditToken:(const SCD_Struct_LS8*)arg1 ;
-(BOOL)canReadMetadataFromSandboxWithAuditToken:(const SCD_Struct_LS8*)arg1 ;
