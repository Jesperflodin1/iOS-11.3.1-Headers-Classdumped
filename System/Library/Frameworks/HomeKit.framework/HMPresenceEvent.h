...
@class NSString, HMPresenceEventActivation, HMThreadSafeMutableArrayCollection;
...
@property (nonatomic,readonly) HMThreadSafeMutableArrayCollection * observedUsers;              //@synthesize observedUsers=_observedUsers - In the implementation block
...
-(HMThreadSafeMutableArrayCollection *)observedUsers;
