...
@class HMAccessory, HMHome, HMApplicationData, NSObject, HMThreadSafeMutableArrayCollection, HMXpcClient, HMFMessageDispatcher, NSOperationQueue, NSUUID, HMPendingRequests, HMDelegateCaller, _HMLocationHandler, NSString, NSArray;
