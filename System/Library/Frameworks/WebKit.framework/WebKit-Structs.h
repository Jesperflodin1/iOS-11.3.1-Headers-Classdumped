...
typedef struct Vector<std::optional<std::__1::pair<WebKit::InteractionInformationRequest, WTF::BlockPtr<void (WebKit::InteractionInformationAtPosition)> > >, 0, WTF::CrashOnOverflow, 16, WTF::FastMalloc> {
	...
	unsigned m_size;
	unsigned m_mask;
} Vector<std::optional<std::__1::pair<WebKit::InteractionInformationRequest, WTF::BlockPtr<void (WebKit::InteractionInformationAtPosition)> > >, 0, WTF::CrashOnOverflow, 16, WTF::FastMalloc>;
...
typedef struct Vector<PDFPageInfo, 0, WTF::CrashOnOverflow, 16, WTF::FastMalloc> {
	/*function pointer*/void* m_buffer;
	unsigned m_capacity;
	unsigned m_size;
	unsigned m_mask;
} Vector<PDFPageInfo, 0, WTF::CrashOnOverflow, 16, WTF::FastMalloc>;

typedef struct RetainPtr<UIPDFSelection> {
	void m_ptr;
} RetainPtr<UIPDFSelection>;

typedef struct Vector<WTF::RetainPtr<UIPDFSelection>, 0, WTF::CrashOnOverflow, 16, WTF::FastMalloc> {
	RetainPtr<UIPDFSelection> m_buffer;
	unsigned m_capacity;
	unsigned m_size;
	unsigned m_mask;
} Vector<WTF::RetainPtr<UIPDFSelection>, 0, WTF::CrashOnOverflow, 16, WTF::FastMalloc>;
