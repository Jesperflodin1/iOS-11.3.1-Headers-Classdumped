...
@interface WKContentView : UIView <_WKWebViewPrintProvider, UIGestureRecognizerDelegate, UITextAutoscrolling, UITextInputMultiDocument, UITextInputPrivate, UIWebFormAccessoryDelegate, UIWebTouchEventsGestureRecognizerDelegate, UIWKInteractionViewProtocol, WKActionSheetAssistantDelegate, WKFileUploadPanelDelegate, UIDragInteractionDelegate, UIDropInteractionDelegate, UIPreviewItemDelegate> {
	...
	Vector<std::optional<std::__1::pair<WebKit::InteractionInformationRequest, WTF::BlockPtr<void (WebKit::InteractionInformationAtPosition)> > >, 0, WTF::CrashOnOverflow, 16, WTF::FastMalloc>* _pendingPositionInformationHandlers;
...
-(void)_didGetTapHighlightForRequest:(unsigned long long)arg1 color:(const Color*)arg2 quads:(const Vector<WebCore::FloatQuad, 0, WTF::CrashOnOverflow, 16, WTF::FastMalloc>*)arg3 topLeftRadius:(const IntSize*)arg4 topRightRadius:(const IntSize*)arg5 bottomLeftRadius:(const IntSize*)arg6 bottomRightRadius:(const IntSize*)arg7 ;
...
-(Vector<WebKit::OptionItem, 0, WTF::CrashOnOverflow, 16, WTF::FastMalloc>*)assistedNodeSelectOptions;
