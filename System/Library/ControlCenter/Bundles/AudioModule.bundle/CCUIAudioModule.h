...
#import <AudioModule/CCUIAudioModuleViewControllerDelegate.h>

@class UIViewController, CCUIAudioModuleViewController, CCUISliderModuleBackgroundViewController, NSString;
