...
@property (assign,nonatomic) SCD_Struct_HU3 layoutMetrics;                                              //@synthesize layoutMetrics=_layoutMetrics - In the implementation block
...
-(void)setLayoutMetrics:(SCD_Struct_HU3)arg1 ;
-(SCD_Struct_HU3)layoutMetrics;
@end
