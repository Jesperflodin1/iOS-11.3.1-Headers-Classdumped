...
@property (retain) NSDictionary * exceptions;                                             //@synthesize exceptions=_exceptions - In the implementation block
@property (retain) NSString * interfaceName;                                              //@synthesize interfaceName=_interfaceName - In the implementation block
@property (__weak) id<NSPConnectionInfoSource> source;                                    //@synthesize source=_source - In the implementation block
@property (retain) NSArray * timingIntervals;                                             //@synthesize timingIntervals=_timingIntervals - In the implementation block
@property (assign) double timeToFirstByte;                                                //@synthesize timeToFirstByte=_timeToFirstByte - In the implementation block
@property (assign) long long tunnelConnectionError;                                       //@synthesize tunnelConnectionError=_tunnelConnectionError - In the implementation block
@property (assign) BOOL isTFOProbeSucceeded;                                              //@synthesize isTFOProbeSucceeded=_isTFOProbeSucceeded - In the implementation block
...
@property (readonly) long long fallbackReasonCategory;                                    //@synthesize fallbackReasonCategory=_fallbackReasonCategory - In the implementation block
...
-(void)setSource:(id<NSPConnectionInfoSource>)arg1 ;
-(void)setEdgeType:(long long)arg1 ;
-(id<NSPConnectionInfoSource>)source;
-(BOOL)TFOSucceeded;
-(BOOL)isMultipath;
