...
@class UIViewController, UIPreviewInteraction, NSTimer, _TtC18ASMessagesProvider28ContextActionsViewController, UIViewPropertyAnimator, UILongPressGestureRecognizer, NSString;
...
@interface ContextActionsPresentationRegistration : NSObject <UIGestureRecognizerDelegate, UIPreviewInteractionDelegate> {
	...
	_TtC18ASMessagesProvider28ContextActionsViewController* _orbContextActionsViewController;
...
@property (nonatomic,retain) _TtC18ASMessagesProvider28ContextActionsViewController * orbContextActionsViewController;              //@synthesize orbContextActionsViewController=_orbContextActionsViewController - In the implementation block
...
-(void)setOrbContextActionsViewController:(_TtC18ASMessagesProvider28ContextActionsViewController *)arg1 ;
...
-(_TtC18ASMessagesProvider28ContextActionsViewController *)orbContextActionsViewController;
