...
@interface ASMessagesProvider.PurchasesCollectionViewDelegate : NSObject <UICollectionViewDelegate, UICollectionViewDelegateFlowLayout> {
...
@property (copy,nonatomic) id didScrollHandler; 
...
-(id)didScrollHandler;
-(void)setDidScrollHandler:(id)arg1 ;
