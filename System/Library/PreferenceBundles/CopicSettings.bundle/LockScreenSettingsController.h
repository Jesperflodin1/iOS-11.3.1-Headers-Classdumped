...
@interface LockScreenSettingsController : CopicBaseSettingsController
-(BOOL)isCopicEnabledForLockScreen;
-(void)lockScreenEnabledOrDisabled:(id)arg1 specifier:(id)arg2 ;
-(id)specifiers;
@end
