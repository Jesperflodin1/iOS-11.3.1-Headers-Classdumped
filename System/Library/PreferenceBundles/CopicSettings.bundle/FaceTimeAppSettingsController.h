...
@interface FaceTimeAppSettingsController : CopicBaseSettingsController
-(BOOL)isCopicEnabledForFaceTime;
-(BOOL)isFavoritesEnabled;
-(void)faceTimeAppEnabledOrDisabled:(id)arg1 specifier:(id)arg2 ;
-(void)favoritesEnabledOrDisabled:(id)arg1 specifier:(id)arg2 ;
-(id)specifiers;
@end
