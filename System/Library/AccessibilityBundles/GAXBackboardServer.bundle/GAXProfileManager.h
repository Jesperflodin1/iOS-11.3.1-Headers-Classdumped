...
@interface GAXProfileManager : NSObject {
	...
	NSDictionary* _AACOverridePropertiesMap;
...
@property (nonatomic,retain) NSDictionary * AACOverridePropertiesMap;                                         //@synthesize AACOverridePropertiesMap=_AACOverridePropertiesMap - In the implementation block
...
@property (assign,nonatomic,__weak) id<GAXProfileManagerDelegate> delegate;                                   //@synthesize delegate=_delegate - In the implementation block
...
-(void)setAACOverridePropertiesMap:(NSDictionary *)arg1 ;
...
-(NSDictionary *)AACOverridePropertiesMap;
-(id)_fallbackValueForProfileKey:(id)arg1 configuration:(unsigned)arg2 ;
...
-(BOOL)appWhitelistActiveAndContainsAdditionalApp:(id)arg1 ;
