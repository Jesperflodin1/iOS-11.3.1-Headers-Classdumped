...
-(int)_computeBilateralSpace:(CVBufferRef)arg1 sigma_s:(int)arg2 sigma_r_luma:(int)arg3 sigma_r_chroma:(int)arg4 ;
-(int)hashTableSize;
-(int)_addHashKeyAtX:(int)arg1 Y:(int)arg2 key:(unsigned long long)arg3 ;
