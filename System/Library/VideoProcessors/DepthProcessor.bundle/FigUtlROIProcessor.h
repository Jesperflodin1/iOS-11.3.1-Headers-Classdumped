...
@interface FigUtlROIProcessor : NSObject {
	...
	SCD_Struct_Fi15 _originalToRoiMatrix;
	SCD_Struct_Fi15 _roiToOriginalMatrix;

}

@property (readonly) SCD_Struct_Fi15 originalToRoiMatrix;              //@synthesize originalToRoiMatrix=_originalToRoiMatrix - In the implementation block
@property (readonly) SCD_Struct_Fi15 roiToOriginalMatrix;              //@synthesize roiToOriginalMatrix=_roiToOriginalMatrix - In the implementation block
...
-(SCD_Struct_Fi15)originalToRoiMatrix;
-(SCD_Struct_Fi15)roiToOriginalMatrix;
-(CGPoint)roiToOriginal:(CGPoint)arg1 ;
-(CGPoint)originalToRoi:(CGPoint)arg1 ;
-(SCD_Struct_Fi15)matrix:(int)arg1 rectangle:(CGRect)arg2 scaleX:(double)arg3 scaleY:(double)arg4 inverse:(SCD_Struct_Fi15*)arg5 ;
