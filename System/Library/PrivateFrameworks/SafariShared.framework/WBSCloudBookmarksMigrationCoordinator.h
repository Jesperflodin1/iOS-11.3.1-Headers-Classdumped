...
@class NSObject, WBSCloudBookmarksMigrationRampEvaluator, WBSCloudBookmarksMigrationReadinessDecider, NSTimer, NSString;
...
@property (assign,getter=isRampEnabled,nonatomic) BOOL rampEnabled;                                                              //@synthesize rampEnabled=_rampEnabled - In the implementation block
