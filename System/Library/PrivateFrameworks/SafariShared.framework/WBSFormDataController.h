...
-(void)getCredentialMatchesForURL:(id)arg1 matchingPartialUsername:(id)arg2 omittingCredentialsUserHasDeniedAccessTo:(BOOL)arg3 withCompletionHandler:(/*^block*/id)arg4 ;
