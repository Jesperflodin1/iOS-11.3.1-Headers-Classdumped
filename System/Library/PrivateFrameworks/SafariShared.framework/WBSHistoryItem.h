...
@interface WBSHistoryItem : NSObject {
	...
	Vector<int, 0, WTF::CrashOnOverflow, 16, WTF::FastMalloc>* _dailyVisitCountScores;
	Vector<int, 0, WTF::CrashOnOverflow, 16, WTF::FastMalloc>* _weeklyVisitCountScores;
...
-(Vector<double, 0, WTF::CrashOnOverflow, 16, WTF::FastMalloc>*)_timesOfVisitsToSynthesizeFromDailyCounts:(const Vector<int, 0, WTF::CrashOnOverflow, 16, WTF::FastMalloc>*)arg1 weeklyCounts:(const Vector<int, 0, WTF::CrashOnOverflow, 16, WTF::FastMalloc>*)arg2 ;
-(Vector<double, 0, WTF::CrashOnOverflow, 16, WTF::FastMalloc>*)_timesForSynthesizedVisitsPreceedingDailyAndWeeklyRange:(unsigned long long)arg1 ;
...
-(Vector<double, 0, WTF::CrashOnOverflow, 16, WTF::FastMalloc>*)_timesForVisits:(unsigned long long)arg1 toSynthesizeBetweenStartTime:(double)arg2 endTime:(double)arg3 ;
