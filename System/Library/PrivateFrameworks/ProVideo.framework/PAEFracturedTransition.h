...
-(void)dealloc;
-(id)properties;
-(BOOL)frameSetup:(SCD_Struct_PA47*)arg1 inputInfoA:(SCD_Struct_PA48)arg2 inputInfoB:(SCD_Struct_PA48)arg3 timeFraction:(float)arg4 hardware:(BOOL*)arg5 software:(BOOL*)arg6 ;
-(BOOL)canThrowRenderOutput:(id)arg1 withInputA:(id)arg2 withInputB:(id)arg3 withTimeFraction:(float)arg4 withInfo:(SCD_Struct_PA47*)arg5 ;
