...
-(id)init;
-(void)dealloc;
-(void)releaseAllUnusedEffects:(SCD_Struct_PV19)arg1 ;
...
-(void)loadEffects:(SCD_Struct_PV19)arg1 playerRate:(float)arg2 ;
-(BOOL)loadTimeIsNearEnd:(SCD_Struct_PV19)arg1 ;
