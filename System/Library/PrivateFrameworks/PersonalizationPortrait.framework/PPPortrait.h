...
+(void)_triggerDelayedOperationWithCoalescingToken:(unsigned long long*)arg1 operation:(/*^block*/id)arg2 ;
...
+(void)_logUsedFeedbackForItems:(id)arg1 domain:(PPMPortraitDomain_)arg2 ;
+(void)_logOverallEngagement:(id)arg1 domain:(PPMPortraitDomain_)arg2 ;
+(void)_logEngagementFeedbackForItems:(id)arg1 domain:(PPMPortraitDomain_)arg2 ;
