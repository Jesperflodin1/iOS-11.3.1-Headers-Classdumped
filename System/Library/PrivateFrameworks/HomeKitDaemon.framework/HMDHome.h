...
@property (assign,nonatomic) long long lastKnownReachableIPAndMediaAccessoryCount;                                        //@synthesize lastKnownReachableIPAndMediaAccessoryCount=_lastKnownReachableIPAndMediaAccessoryCount - In the implementation block
...
-(void)_getRunTimeStateUpdate:(BOOL)arg1 includeHAPAccessoryState:(BOOL)arg2 completion:(/*^block*/id)arg3 ;
...
-(void)getRunTimeStateUpdate:(BOOL)arg1 includeHAPAccessoryState:(BOOL)arg2 completion:(/*^block*/id)arg3 ;
