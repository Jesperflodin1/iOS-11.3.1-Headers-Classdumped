...
@class HMDKeyTransferAgent, HMDSoftwareUpdateManager, HMDHomeManagerObjectLookup, HMDCompanionManager, NSMutableDictionary, NSMutableArray, NSDictionary, NSMutableSet, HMDAccessoryBrowser, HMDHomeManagerObjectChangeHandler, NSUUID, NSObject, HMFMessageDispatcher, HMDCentralMessageDispatcher, HMDPairedSync, HMDNameValidator, HMDPendingCloudSyncTransactions, HMDPowerManager, HMDCloudManager, HMDWatchManager, HMDBackingStore, HMDMessageFilterChain, HMDRemoteIdentityRegistry, HMDCloudDataSyncStateFilter, HMDLocation, HMDFMFHandler, HMDApplicationRegistry, HMDAccountRegistry, HMFDumpCategory, HMDClientConnection, HMDAssistantGather, HMFTimer, HMDTimeInformationMonitor, HMDApplicationData, HMDResidentMesh, HMDSyncOperationManager, HMDCloudAccount, HMDAWDLogEventObserver, HMDDevice, NSString;

@interface HMDHomeManager : HMFObject <HMDAccountDelegate, HMDAccountRegistryDelegate, HMDCompanionManagerDelegate, HMDCompanionManagerDelegate, HMDDeviceSetupSessionDelegate, HMDWatchManagerDelegate, HMFMessageReceiver, IDSServiceDelegate, HMDAccessoryBrowserManagerDelegate, HMFTimerDelegate, HAPFragmentationStreamDelegate, HMDPairedSyncDelegate, HMDUserManagementOperationDelegate, HMDBackingStoreObjectProtocol> {
...
@property (nonatomic,retain) HMFTimer * debouceHomesUpdateTimer;                                                //@synthesize debouceHomesUpdateTimer=_debouceHomesUpdateTimer - In the implementation block
...
-(void)_runUploadHomeConfigToCloudRowIDs:(id)arg1 forcePush:(BOOL)arg2 syncCompletion:(/*^block*/id)arg3 ;
...
-(void)setDebouceHomesUpdateTimer:(HMFTimer *)arg1 ;
-(HMFTimer *)debouceHomesUpdateTimer;
...
-(void)_getRuntimeStateUpdateForMediaAccessories:(BOOL)arg1 includeHAPAccessoryState:(BOOL)arg2 completion:(/*^block*/id)arg3 ;
