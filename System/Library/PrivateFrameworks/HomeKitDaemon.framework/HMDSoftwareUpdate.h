...
@class HMSoftwareUpdateDocumentationMetadata, NSUUID, HMFSoftwareVersion, NSObject, HMFMessageDispatcher, HMDAccessory, HMDSoftwareUpdateModel, NSString, NSSet;
