...
@class NSObject, NSUUID, HMFMessageDispatcher, HMFTimer, NSDate, HMDHomeManager, NSString;
...
@property (assign,nonatomic) BOOL deviceSetupRunning;                                                          //@synthesize deviceSetupRunning=_deviceSetupRunning - In the implementation block
