...
@class NSObject, CKContainer, CKDatabase, HMDCloudCache, HMFMessageDispatcher, CKServerChangeToken, APSConnection, HMDCloudDataSyncStateFilter, NSUUID, HMDHomeManager, NSMutableArray, HMDCloudLegacyZone, HMDCloudMetadataZone, HMDCloudHomeManagerZone, NSData, NSString;
...
@property (nonatomic,retain) CKServerChangeToken * databaseServerChangeToken;                           //@synthesize databaseServerChangeToken=_databaseServerChangeToken - In the implementation block
...
@property (assign,nonatomic) int proxSetupNotificationToken;                                            //@synthesize proxSetupNotificationToken=_proxSetupNotificationToken - In the implementation block
...
@property (assign,getter=isFirstV3Fetch,nonatomic) BOOL firstV3Fetch;                                   //@synthesize firstV3Fetch=_firstV3Fetch - In the implementation block
...
-(void)_removeZones:(id)arg1 completionHandler:(/*^block*/id)arg2 ;
