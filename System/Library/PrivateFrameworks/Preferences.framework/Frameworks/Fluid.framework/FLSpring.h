...
@property (assign,nonatomic) double stableValueThreshold; 
@property (assign,nonatomic) double stableVelocityThreshold; 
...
@property (assign,nonatomic) double timeFactor;                                  //@synthesize timeFactor=_timeFactor - In the implementation block
