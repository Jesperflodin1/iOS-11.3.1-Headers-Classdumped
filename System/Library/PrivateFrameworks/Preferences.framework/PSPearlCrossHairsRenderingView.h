...
@class NSObject, MTLSAnimatablePathCollection, PSPearlCrossHairsManager, MTLSPathBufferData, MTLSplineRenderer;
...
@property (retain) PSPearlCrossHairsManager * crosshairsInstanceManager;                 //@synthesize crosshairsInstanceManager=_crosshairsInstanceManager - In the implementation block
...
-(void)setCrosshairsInstanceManager:(PSPearlCrossHairsManager *)arg1 ;
-(PSPearlCrossHairsManager *)crosshairsInstanceManager;
