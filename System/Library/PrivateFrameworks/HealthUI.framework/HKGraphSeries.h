...
-(void)autoscaleYAxisWithValueRange:(id)arg1 yAxisRange:(id)arg2 xAxis:(id)arg3 dateZoom:(long long)arg4 chartRect:(CGRect)arg5 animated:(BOOL)arg6 ;
-(id)valueRangeForYAxisWithXAxisRange:(id)arg1 dateZoom:(long long)arg2 chartRect:(CGRect)arg3 ;
-(void)autoscaleYAxisWithYAxisRange:(id)arg1 chartRect:(CGRect)arg2 animated:(BOOL)arg3 ;
