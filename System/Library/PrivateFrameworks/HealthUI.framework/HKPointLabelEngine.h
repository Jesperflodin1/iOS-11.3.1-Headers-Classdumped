...
@interface HKPointLabelEngine : NSObject {
	...
	SCD_Struct_HK12 _previousRenderingData;
	SCD_Struct_HK12 _currentRenderingData;
...
@property (assign,nonatomic) SCD_Struct_HK13 previousRenderingData;              //@synthesize previousRenderingData=_previousRenderingData - In the implementation block
@property (assign,nonatomic) SCD_Struct_HK13 currentRenderingData;               //@synthesize currentRenderingData=_currentRenderingData - In the implementation block
...
-(SCD_Struct_HK13)_computeRenderingDataForValue:(double)arg1 transformedPoint:(CGPoint)arg2 previousSlope:(long long)arg3 nextSlope:(long long)arg4 previousOptions:(long long)arg5 ;
...
-(SCD_Struct_HK13)previousRenderingData;
-(void)setPreviousRenderingData:(SCD_Struct_HK13)arg1 ;
-(SCD_Struct_HK13)currentRenderingData;
-(void)setCurrentRenderingData:(SCD_Struct_HK13)arg1 ;
