...
-(void)drawLabelsWithModelRange:(id)arg1 chartRect:(CGRect)arg2 zoomScale:(double)arg3 contentOffset:(CGPoint)arg4 renderView:(id)arg5 maximumLabelSize:(CGSize*)arg6 ;
...
-(void)_drawTextForModelRange:(id)arg1 inRect:(CGRect)arg2 zoomScale:(double)arg3 contentOffset:(CGPoint)arg4 renderView:(id)arg5 style:(id)arg6 maximumLabelSize:(CGSize*)arg7 ;
