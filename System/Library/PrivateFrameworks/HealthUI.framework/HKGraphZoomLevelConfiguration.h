...
+(id)_snappingStartDateWithStartDate:(id)arg1 velocity:(CGPoint)arg2 calendar:(id)arg3 timeScope:(long long)arg4 ;
+(long long)timeScopeForDateRange:(id)arg1 ;
+(id)snappingRangeForRange:(id)arg1 axisRange:(id)arg2 timeScope:(long long)arg3 velocity:(CGPoint)arg4 calendar:(id)arg5 ;
