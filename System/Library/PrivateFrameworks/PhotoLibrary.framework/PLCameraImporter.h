...
@class PLMutableCameraImportQueue, PLCameraImportQueue, NSMutableArray, NSMutableDictionary, PLImportFileManager, NSMutableSet, ICCameraDevice, NSString;
...
@property (nonatomic,copy) NSString * importSessionIdentifier;                          //@synthesize importSessionIdentifier=_importSessionIdentifier - In the implementation block
@property (assign,nonatomic) BOOL isAppleDevice;                                        //@synthesize isAppleDevice=_isAppleDevice - In the implementation block
@property (assign,nonatomic,__weak) id<PLCameraImporterDelegate> delegate;              //@synthesize delegate=_delegate - In the implementation block
