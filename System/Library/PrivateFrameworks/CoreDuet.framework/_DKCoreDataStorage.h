...
@class NSManagedObjectModel, NSMutableDictionary, NSMapTable, NSObject, _DKDataProtectionStateMonitor, NSFileManager, NSCloudKitMirroringDelegate, NSString, NSURL;
