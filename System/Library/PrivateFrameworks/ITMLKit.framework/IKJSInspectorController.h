...
@class IKAppContext, RWIProtocolInspector, NSDate, IKDOMDocument, NSString, NSMutableArray, IKJSInspectorDOMAgent, IKJSInspectorNetworkAgent, IKJSInspectorPageAgent, IKJSInspectorCSSAgent, IKJSInspectorStorageAgent;
...
@property (nonatomic,readonly) NSMutableArray * appDocumentStack;                                              //@synthesize appDocumentStack=_appDocumentStack - In the implementation block
...
@property (nonatomic,__weak,readonly) IKDOMDocument * activeDocument;                                          //@synthesize activeDocument=_activeDocument - In the implementation block
@property (nonatomic,copy,readonly) NSString * activeDocumentIdentifier;                                       //@synthesize activeDocumentIdentifier=_activeDocumentIdentifier - In the implementation block
...
-(NSMutableArray *)appDocumentStack;
...
-(NSString *)activeDocumentIdentifier;
