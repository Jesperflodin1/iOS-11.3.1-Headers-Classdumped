...
@property (assign,nonatomic) BOOL switchControlPointPickerHighPrecisionEnabled; 
...
-(NSString *)zoomCurrentDockPosition;
...
-(void)setZoomCurrentDockPosition:(NSString *)arg1 ;
...
-(void)setDownloadedSiriVoices:(NSSet *)arg1 ;
