...
@class AXEventHandInfoRepresentation, AXEventKeyInfoRepresentation, AXEventAccelerometerInfoRepresentation, AXEventGameControllerInfoRepresentation, AXEventPointerInfoRepresentation, NSString, NSData, AXEventData;
