...
@protocol PRSSessionController, OS_dispatch_queue;
...
@property (nonatomic,readonly) NSString * modelL3Version;                           //@synthesize modelL3Version=_modelL3Version - In the implementation block
...
-(id)queryWithEngagedSuggestion:(id)arg1 keyboardLanguage:(id)arg2 externalId:(unsigned)arg3 handler:(id)arg4 queryIdent:(unsigned long long)arg5 whyQuery:(unsigned long long)arg6 ;
-(id)dictationQueryWithResponse:(id)arg1 keyboardLanguage:(id)arg2 externalId:(unsigned)arg3 webSearch:(BOOL)arg4 handler:(id)arg5 queryIdent:(unsigned long long)arg6 whyQuery:(unsigned long long)arg7 ;
