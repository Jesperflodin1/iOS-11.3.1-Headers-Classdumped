...
@interface OSLogEventProxy : NSObject <OSLogEventProvider> {
	...
	SCD_Struct_OS11 _eint;
	os_activity_map_sRef _aid_map;
	SCD_Struct_OS16* _event;
...
-(BOOL)_setLogEvent:(SCD_Struct_OS16*)arg1 rangeUUIDIndex:(unsigned long long)arg2 machTimebase:(mach_timebase_info*)arg3 ;
