...
@class NSArray, NSString, VMURangeToStringMap, NSDictionary, VMUNodeToStringMap, VMUGraphStackLogReader, VMUDebugTimer, VMUClassInfoMap;
...
@property (assign,nonatomic) BOOL javaScriptCoreUsingPoisoning;                     //@synthesize javaScriptCoreUsingPoisoning=_javaScriptCoreUsingPoisoning - In the implementation block
...
-(id)_detailedNodeOffsetDescription:(SCD_Struct_VM2)arg1 withSourceNode:(unsigned)arg2 destinationNode:(unsigned)arg3 alignmentSpacing:(unsigned)arg4 ;
...
-(id)nodeDescription:(unsigned)arg1 withDestinationNode:(unsigned)arg2 referenceInfo:(SCD_Struct_VM2)arg3 ;
-(id)nodeOffsetDescription:(SCD_Struct_VM2)arg1 withSourceNode:(unsigned)arg2 destinationNode:(unsigned)arg3 ;
-(id)referenceDescription:(SCD_Struct_VM2)arg1 withSourceNode:(unsigned)arg2 destinationNode:(unsigned)arg3 alignmentSpacing:(unsigned)arg4 ;
