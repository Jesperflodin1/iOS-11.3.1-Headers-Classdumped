...
@class VMUTaskMemoryScanner, NSString, NSArray, VMUClassInfoMap, NSMutableDictionary, NSMapTable, NSMutableSet, NSHashTable, VMUNonOverlappingRangeArray;
...
-(void*)_dlopenLibSwiftRemoteMirrorNearLibSwiftCoreWithSymbolicator:(CSTypeRef)arg1 avoidSystem:(BOOL)arg2 ;
