...
@class NSString, NSNumber, NSMutableDictionary, NSMutableSet, BRMangledID, BRCAccountSession, BRCPrivateClientZone, NSObject, brc_task_tracker, BRCPQLConnection, BRCALRowID, BRCZoneRowID, BRContainer, BRCRelativePath, BRCFSEventsMonitor, NSURL, BRCSyncContext;
