...
-(PQLResultSet*)itemsParentedToThisZoneButLivingInAnOtherZone;
...
-(PQLResultSet*)_faultsEnumeratorFromRow:(unsigned long long)arg1 batchSize:(unsigned long long)arg2 ;
...
-(PQLResultSet*)documentsNotIdleEnumeratorWithDB:(id)arg1 ;
