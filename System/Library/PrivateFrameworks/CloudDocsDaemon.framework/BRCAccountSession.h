...
-(PQLResultSet*)_appLibrariesEnumerator:(id)arg1 ;
...
-(PQLResultSet*)foldersNeedingTransmogrifyEnumerator;
-(PQLResultSet*)bouncedItemsEnumerator;
-(PQLResultSet*)itemsNeedingIndexingEnumeratorFromNotifRank:(unsigned long long)arg1 batchSize:(unsigned long long)arg2 ;
...
-(void)enumerateItemsWithShareIDUnderParent:(id)arg1 db:(id)arg2 block:(/*^block*/id)arg3 ;
