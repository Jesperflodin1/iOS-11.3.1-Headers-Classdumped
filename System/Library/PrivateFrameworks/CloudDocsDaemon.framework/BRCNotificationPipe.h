...
@class BRNotificationQueue, BRCXPCClient, BRCItemGlobalID, BRFileObjectID, NSString, BRCDataOrDocsScopeGatherer, NSMutableDictionary, NSMutableSet, NSSet, BRCNotificationManager, NSObject;
