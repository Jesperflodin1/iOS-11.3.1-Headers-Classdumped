...
@class NSString, NSArray, IMAccount, NSData, NSMutableDictionary, IMMessage, NSMutableArray, NSMutableSet, NSNumber, IMTimingCollection, IMScheduledUpdater, IMSendProgress, NSDictionary, NSDate, MKMapItem, NSSet, IMChatRegistry, IMHandle;
