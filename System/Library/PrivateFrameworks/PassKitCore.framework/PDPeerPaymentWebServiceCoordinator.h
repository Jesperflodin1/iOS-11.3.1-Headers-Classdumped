...
@class PDPushNotificationManager, NSObject, PDPeerPaymentWebServiceArchiver, PKPeerPaymentWebService, PKPeerPaymentAccount, PDAssertionManager, NSMutableArray, PDCloudStoreNotificationCoordinator, PKPaymentWebService, NSString;
