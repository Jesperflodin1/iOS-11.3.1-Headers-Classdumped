...
-(void)_fetchImageSetContainerForUniqueID:(id)arg1 ofType:(long long)arg2 displayProfile:(id)arg3 usingSynchronousProxy:(BOOL)arg4 withCompletion:(/*^block*/id)arg5 ;
-(id)_extendedRemoteObjectProxyWithErrorHandler:(/*^block*/id)arg1 ;
-(void)_fetchImageSetForUniqueID:(id)arg1 ofType:(long long)arg2 displayProfile:(id)arg3 usingSynchronousProxy:(BOOL)arg4 withCompletion:(/*^block*/id)arg5 ;
...
-(void)supportedPartnersForDigitalIssuance:(/*^block*/id)arg1 ;
-(id)_remoteLibrary;
-(BOOL)migrateData;
