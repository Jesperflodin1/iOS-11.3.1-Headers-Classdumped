...
@class NSDictionary, NSArray, NSString, NSNumber, NSURL, NPLocation, NSDate, NSPNetworkAgent, NPWaldoLocationManager, NSMutableDictionary, NPTuscanyEdge, NSObject, NWNetworkAgentRegistration, NSUUID, NSData;
...
-(unsigned)getFailureReasonForLatencies:(id)arg1 ;
