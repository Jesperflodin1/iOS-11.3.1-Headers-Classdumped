...
-(void)_decorateAndWriteImage:(id)arg1 imagePath:(id)arg2 scaleToSize:(CGSize)arg3 cropToFit:(BOOL)arg4 scalingResult:(unsigned long long)arg5 assetKey:(id)arg6 expiryDate:(id)arg7 requestRecord:(id)arg8 ;
