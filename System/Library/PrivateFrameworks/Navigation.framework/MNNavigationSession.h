...
@class MNRouteManager, GEOComposedWaypoint, MNLocationTracker, GEOMotionContext, MNNavigationAudioSession, MNClassicGuidanceManager, MNGuidanceEventManager, MNTimeAndDistanceUpdater, NSString, MNNavigationTraceManager, MNTrafficIncidentAlert, GEONavigationGuidanceState, MNObserverHashTable, GEOApplicationAuditToken, MNGuidanceSignInfo, NSUUID, MNLocation;
