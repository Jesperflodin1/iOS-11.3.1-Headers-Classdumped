...
@property (nonatomic,retain) NSArray * significantEvents;                            //@synthesize significantEvents=_significantEvents - In the implementation block
...
-(void)setSignificantEvents:(NSArray *)arg1 ;
