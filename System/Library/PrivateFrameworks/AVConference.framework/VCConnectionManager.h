...
@class NSObject, VCConnectionHealthMonitor, NSString;
...
@interface VCConnectionManager : NSObject <VCConnectionHealthMonitorDelegate> {
	...
	SCD_Struct_VC55 _localConnectionStats;
	SCD_Struct_VC55 _remoteConnectionStats;
...
-(int)processWRMNotification:(SCD_Struct_VC37*)arg1 ;
...
-(void)updateConnectionStatsWithIndicatorNoPackets:(SCD_Struct_VC55*)arg1 ;
-(void)updateConnectionStatsWithIndicatorNone:(SCD_Struct_VC55*)arg1 ;
-(void)updateConnectionStatsWithIndicatorPrimaryImproved:(SCD_Struct_VC55*)arg1 ;
