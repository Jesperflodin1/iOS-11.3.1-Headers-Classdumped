...
@interface VCMovieWriter : NSObject <VCMovieWriterProtocol> {
	...
	SCD_Struct_VC33 _lastVideoPresentationTime;
	SCD_Struct_VC33 _lastLocalAudioPresentationTime;
	SCD_Struct_VC33 _lastRemoteAudioPresentationTime;
	SCD_Struct_VC33 _startTime;
	SCD_Struct_VC33 _stillImageTime;
...
-(void)setupInputs;
-(void)processSampleQueue:(opaqueCMBufferQueueRef)arg1 input:(id)arg2 lastPresentationTime:(SCD_Struct_VC33*)arg3 ;
-(void)startWritingAtTime:(SCD_Struct_VC33)arg1 ;
-(void)appendMetaData;
-(void)setupInput:(id)arg1 queue:(opaqueCMBufferQueueRef)arg2 dispatchGroup:(id)arg3 lastPresentationTime:(SCD_Struct_VC33*)arg4 ;
