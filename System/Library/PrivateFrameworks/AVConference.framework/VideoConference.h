...
@class VCAudioIO, VideoConferenceManager, NSMutableDictionary, NSArray, NSMutableArray, FFTMeter, VCImageQueue, VCVideoRule, CameraConferenceSynchronizer, NSString, VCCallSession, NSObject, NSDictionary, VCAudioPowerLevelMonitor, GKNATObserver, VCMoments;
...
-(BOOL)onCaptureFrame:(opaqueCMSampleBufferRef)arg1 frameTime:(SCD_Struct_VC33)arg2 droppedFrames:(int)arg3 cameraStatusBits:(unsigned char)arg4 ;
...
-(BOOL)session:(id)arg1 receivedRemoteFrame:(CVBufferRef)arg2 atTime:(SCD_Struct_VC33)arg3 withScreenAttributes:(id)arg4 videoAttributes:(id)arg5 isFirstFrame:(BOOL)arg6 isVideoPaused:(BOOL)arg7 ;
