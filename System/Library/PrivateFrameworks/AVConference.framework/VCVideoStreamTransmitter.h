...
@interface VCVideoStreamTransmitter : NSObject <VCVideoCaptureClient> {
	...
	int* _packetFlags;
	unsigned _timestamp;
	SCD_Struct_VC33 _latestSampleBufferTimestamp;
...
@property (assign) SCD_Struct_VC33 lastFrameTime;              //@synthesize latestSampleBufferTimestamp=_latestSampleBufferTimestamp - In the implementation block
...
-(SCD_Struct_VC33)lastFrameTime;
-(void)setLastFrameTime:(SCD_Struct_VC33)arg1 ;
