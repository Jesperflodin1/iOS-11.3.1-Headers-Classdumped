...
@class VCNetworkAddress, NSString, NSData, NSMutableDictionary, NSDictionary;
...
@property (assign,nonatomic) unsigned datagramChannelToken;                                          //@synthesize datagramChannelToken=_datagramChannelToken - In the implementation block
-(id)init;
-(void)dealloc;
-(id)description;
...
-(void)setDatagramChannelToken:(unsigned)arg1 ;
