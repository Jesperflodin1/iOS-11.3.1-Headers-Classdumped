...
@property (assign,setter=_setStartingTime:,nonatomic) SCD_Struct_PU4 _startingTime;                                           //@synthesize _startingTime=__startingTime - In the implementation block
...
-(void)_setStartingTime:(SCD_Struct_PU4)arg1 ;
-(void)_setPlayerIsPlaying:(BOOL)arg1 ;
-(void)_refetchPlaceholderImage;
-(SCD_Struct_PU4)_startingTime;
