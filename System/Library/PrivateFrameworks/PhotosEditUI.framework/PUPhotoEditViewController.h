...
@class NSArray, PUPhotoEditToolController, NUMediaView, NURenderPipelineFilter, NUBufferRenderClient, GLKView, PUTouchingGestureRecognizer, PUPhotoEditToolbar, UIButton, PUPhotoEditLivePhotoToolbar, PUEditPluginSession, PUPhotoEditSnapshot, NSURL, NSString, PUAutoAdjustmentController, UIImageView, UITapGestureRecognizer, UILongPressGestureRecognizer, CAMBadgeTextView, PUProgressIndicatorView, NSObject, PUCropToolController, PUFiltersToolController, PUAdjustmentsToolController, PUTrimToolController, _PPTState, CAMLightingControl, CAMLightingNameBadge, PUPhotoEditViewControllerSpec, PUEditableMediaProvider, PUMediaDestination, PXImageLayerModulator, PUPhotoEditValuesCalculator, PLPhotoEditRenderer, PURedeyeToolController, PLPhotoEditAggregateSession, PUPhotoEditResourceLoader, PLPhotoEditMutableModel, PLPhotoEditModel, PUPhotoEditIrisModel, PLEditSource, UIAlertController, UIView;
...
@interface PUPhotoEditViewController : PUEditViewController <UIScrollViewDelegate, UIGestureRecognizerDelegate, UIPopoverPresentationControllerDelegate, PUPhotoEditToolControllerDelegate, PUVideoEditPluginSessionDataSource, PUImageEditPluginSessionDataSource, PUEditPluginSessionDelegate, PXPhotoLibraryUIChangeObserver, PUOneUpAssetTransitionViewController, PLDismissableViewController, PUPhotoEditIrisModelChangeObserver, PHLivePhotoViewDelegate, PUPhotoEditResourceLoaderDelegate, PUViewControllerSpecChangeObserver, NUMediaViewDelegatePrivate, PUPhotoEditToolbarDelegate, CAMLightingControlDelegate, PUPhotoEditLayoutSource> {
	...
	SCD_Struct_PU4 __initialSeekTime;
	SCD_Struct_PU4 __originalStillImageTime;
	SCD_Struct_PU4 __originalVideoDuration;
...
@property (assign,setter=_setInitialSeekTime:,nonatomic) SCD_Struct_PU4 _initialSeekTime;                                                  //@synthesize _initialSeekTime=__initialSeekTime - In the implementation block
...
@property (assign,setter=_setOriginalStillImageTime:,nonatomic) SCD_Struct_PU4 _originalStillImageTime;                                    //@synthesize _originalStillImageTime=__originalStillImageTime - In the implementation block
@property (assign,setter=_setOriginalVideoDuration:,nonatomic) SCD_Struct_PU4 _originalVideoDuration;                                      //@synthesize _originalVideoDuration=__originalVideoDuration - In the implementation block
...
@property (assign,nonatomic) BOOL currentToolShouldAppearUnderneathMediaView;                                                              //@synthesize currentToolShouldAppearUnderneathMediaView=_currentToolShouldAppearUnderneathMediaView - In the implementation block
@property (assign,nonatomic) BOOL oldToolShouldDisappearUnderneathMediaView;                                                               //@synthesize oldToolShouldDisappearUnderneathMediaView=_oldToolShouldDisappearUnderneathMediaView - In the implementation block
@property (nonatomic,retain) UIView * oldToolView;                                                                                         //@synthesize oldToolView=_oldToolView - In the implementation block
...
-(void)_setOriginalStillImageTime:(SCD_Struct_PU4)arg1 ;
-(void)_setOriginalVideoDuration:(SCD_Struct_PU4)arg1 ;
...
-(SCD_Struct_PU4)_originalStillImageTime;
-(void)_setValuesCalculator:(id)arg1 ;
-(void)_setupToolsIfNeeded;
-(SCD_Struct_PU4)_initialSeekTime;
-(void)_setInitialSeekTime:(SCD_Struct_PU4)arg1 ;
...
-(void)setOldToolView:(UIView *)arg1 ;
...
-(CGSize)_scaleSize:(CGSize)arg1 toFitSize:(CGSize)arg2 ;
...
-(SCD_Struct_PU4)_originalVideoDuration;
