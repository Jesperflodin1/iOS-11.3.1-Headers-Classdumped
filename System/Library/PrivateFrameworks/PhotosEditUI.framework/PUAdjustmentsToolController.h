...
@class PUAdjustmentsModeBar, UIScrollView, NSArray, PUAdjustmentsMode, NSMapTable, NSMutableSet, PXUISnappingController, PUAdjustmentsToolControllerSpec, NSString;
