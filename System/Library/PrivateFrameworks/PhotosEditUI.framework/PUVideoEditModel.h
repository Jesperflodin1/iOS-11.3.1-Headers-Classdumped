...
@interface PUVideoEditModel : PUViewModel {
	...
	CGSize _videoSize;
	SCD_Struct_PU7 _initialSlomoRegion;
...
@property (assign,nonatomic) SCD_Struct_PU7 initialSlomoRegion;                  //@synthesize initialSlomoRegion=_initialSlomoRegion - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_PU7 slomoRegion; 
...
-(SCD_Struct_PU7)slomoRegion;
-(double)slomoRegionStartTime;
-(BOOL)_isTimeRange:(SCD_Struct_PU7)arg1 equivalentToTimeRange:(SCD_Struct_PU7)arg2 epsilon:(double)arg3 ;
-(double)videoStartTime;
-(double)videoEndTime;
-(SCD_Struct_PU7)initialSlomoRegion;
...
-(void)setInitialSlomoRegion:(SCD_Struct_PU7)arg1 ;
