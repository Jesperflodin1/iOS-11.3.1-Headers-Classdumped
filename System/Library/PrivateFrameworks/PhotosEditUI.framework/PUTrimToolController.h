...
@interface PUTrimToolController : UIViewController <ISChangeObserver, PULivePhotoTrimScrubberDelegate, UIPopoverPresentationControllerDelegate, PULivePhotoKeyFrameSelectionViewControllerDelegate> {
	...
	SCD_Struct_PU4 _unadjustedStillImageTime;
	SCD_Struct_PU4 _currentStillFrameTime;

}

@property (assign,nonatomic) SCD_Struct_PU4 currentStillFrameTime;                                                     //@synthesize currentStillFrameTime=_currentStillFrameTime - In the implementation block
...
@property (assign,nonatomic) SCD_Struct_PU4 unadjustedStillImageTime;                                                  //@synthesize unadjustedStillImageTime=_unadjustedStillImageTime - In the implementation block
...
-(void)_avPlayerTimeDidChange:(SCD_Struct_PU4)arg1 ;
...
-(SCD_Struct_PU4)unadjustedStillImageTime;
...
-(void)setUnadjustedStillImageTime:(SCD_Struct_PU4)arg1 ;
