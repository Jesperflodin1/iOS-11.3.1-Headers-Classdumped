...
@property (nonatomic,retain) ICQLink * noteDismissLink;                                  //@synthesize noteDismissLink=_noteDismissLink - In the implementation block
...
-(void)setNoteDismissLink:(ICQLink *)arg1 ;
