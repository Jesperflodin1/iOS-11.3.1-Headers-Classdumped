...
@class WGWidgetInfo, NSString, WGWidgetLifeCycleSequence, NSObject, _WGWidgetRemoteViewController, UIView, _WGCAPackageView, NSTimer, NSDate, NSMapTable, _WGBrokenWidgetView, NSMutableDictionary, UIImage, BSAuditToken;
