...
@property (retain) NSObject*<OS_dispatch_queue> system_info_queue;                          //@synthesize system_info_queue=_system_info_queue - In the implementation block
@property (retain) NSObject*<OS_dispatch_queue> sessionQueue;                               //@synthesize sessionQueue=_sessionQueue - In the implementation block
...
-(void)setSystem_info_queue:(NSObject*<OS_dispatch_queue>)arg1 ;
...
-(NSObject*<OS_dispatch_queue>)system_info_queue;
