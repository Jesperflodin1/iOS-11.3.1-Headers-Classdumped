...
@protocol OS_dispatch_queue, OS_dispatch_group, CSSpeechControllerDelegate;
@class NSObject, CSAudioConverter, CSAudioSampleRateConverter, NSDictionary, CSAudioZeroCounter, CSEndpointerProxy, CSSpeechManager, CSAudioFileWriter, NSString;
...
@property (nonatomic,retain) CSAudioFileWriter * audioFileWriter;                         //@synthesize audioFileWriter=_audioFileWriter - In the implementation block
...
-(void)setAudioFileWriter:(CSAudioFileWriter *)arg1 ;
