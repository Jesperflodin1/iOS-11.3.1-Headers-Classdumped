...
+(void)initialize;
+(vector<PKInputPoint, std::__1::allocator<PKInputPoint> >*)inputPointsFromPath:(CGPathRef)arg1 ;
-(id)init;
-(void)dealloc;
-(void)reset;
-(void)addPoint:(SCD_Struct_PK21)arg1 ;
...
-(id)strokeFromPath:(CGPathRef)arg1 ink:(id)arg2 inputScale:(double)arg3 ;
...
-(PKStrokePoint)outputCurrentStrokePoint:(SCD_Struct_PK21)arg1 ;
-(PKDecompressionFilter*)decompressionFilter;
-(PKStrokePoint)outputPoint:(SCD_Struct_PK21)arg1 baseValues:(PKStrokePoint)arg2 ;
...
-(void)_drawingAddPoint:(SCD_Struct_PK21)arg1 ;
...
-(void)drawingUpdatePoint:(SCD_Struct_PK21)arg1 ;
