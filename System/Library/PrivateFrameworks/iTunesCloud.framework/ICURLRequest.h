...
@class NSProgress, NSMutableArray, NSObject, ICRequestContext, NSURLRequest, NSURLSessionTask, NSURLResponse, NSMutableData, NSURL, NSError, NSDictionary, NSString;
