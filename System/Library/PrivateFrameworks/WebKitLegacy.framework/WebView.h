...
@class WebViewPrivate, WebUITextIndicatorData, NSString, NSURL, NSData, DOMRange, DOMCSSStyleDeclaration, NSUndoManager, WebFrame, WebBackForwardList, WebScriptObject, WebPreferences, WAKWindow, DOMDocument;
...
@property (getter=_dataInteractionCaretRect,nonatomic,readonly) CGRect dataInteractionCaretRect; 
...
@property (assign,setter=_setUnobscuredSafeAreaInsets:,nonatomic) WebEdgeInsets _unobscuredSafeAreaInsets; 
...
-(void)_startDrag:(const DragItem*)arg1 ;
...
-(DragData*)dragDataForSession:(id)arg1 client:(CGPoint)arg2 global:(CGPoint)arg3 operation:(unsigned long long)arg4 ;
...
-(void)_setHostApplicationProcessIdentifier:(int)arg1 auditToken:(SCD_Struct_We67)arg2 ;
...
-(unsigned long long)_enteredDataInteraction:(id)arg1 client:(CGPoint)arg2 global:(CGPoint)arg3 operation:(unsigned long long)arg4 ;
-(unsigned long long)_updatedDataInteraction:(id)arg1 client:(CGPoint)arg2 global:(CGPoint)arg3 operation:(unsigned long long)arg4 ;
-(id)_dataOperationTextIndicator;
-(void)_exitedDataInteraction:(id)arg1 client:(CGPoint)arg2 global:(CGPoint)arg3 operation:(unsigned long long)arg4 ;
-(BOOL)_tryToPerformDataInteraction:(id)arg1 client:(CGPoint)arg2 global:(CGPoint)arg3 operation:(unsigned long long)arg4 ;
-(void)_performDataInteraction:(id)arg1 client:(CGPoint)arg2 global:(CGPoint)arg3 operation:(unsigned long long)arg4 ;
-(void)_endedDataInteraction:(CGPoint)arg1 global:(CGPoint)arg2 ;
-(BOOL)isLoading;
-(void)_setUnobscuredSafeAreaInsets:(WebEdgeInsets)arg1 ;
