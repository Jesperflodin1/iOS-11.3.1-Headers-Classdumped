...
@protocol MTLCommandQueue, MTLBuffer;
#import <LocalAuthenticationPrivateUI/LocalAuthenticationPrivateUI-Structs.h>
@class MTKView, CAMetalLayer, MTLRenderPassDescriptor;
...
-(id)initWithMTKView:(id)arg1 sharedState:(const renderer_shared_state*)arg2 ;
-(void)invalidateRenderPassDescriptor;
-(unsigned long long)addSpline:(const spline*)arg1 ;
-(void)setGlobalAnimationTargets:(const vector<LAUI_uniform_cubic_b_spline_renderer::global_state, std::__1::allocator<LAUI_uniform_cubic_b_spline_renderer::global_state> >*)arg1 withCompletion:(/*^block*/id)arg2 ;
-(void)setSplineAnimationTargets:(const vector<LAUI_uniform_cubic_b_spline_renderer::spline_state, std::__1::allocator<LAUI_uniform_cubic_b_spline_renderer::spline_state> >*)arg1 forSpline:(unsigned long long)arg2 withCompletion:(/*^block*/id)arg3 ;
-(void)setInstanceAnimationTargets:(const vector<LAUI_uniform_cubic_b_spline_renderer::spline_instance_state, std::__1::allocator<LAUI_uniform_cubic_b_spline_renderer::spline_instance_state> >*)arg1 forSpline:(unsigned long long)arg2 instance:(unsigned long long)arg3 withCompletion:(/*^block*/id)arg4 ;
