...
@class NSMutableDictionary, NSString, NSURL, SFCompanionAdvertiser, NSMutableSet, NSError, NSDate, NSData, NSSet, NSDictionary, UAUserActivityManager, NSUUID, NSObject, CSSearchableItemAttributeSet, NSUserActivity;
