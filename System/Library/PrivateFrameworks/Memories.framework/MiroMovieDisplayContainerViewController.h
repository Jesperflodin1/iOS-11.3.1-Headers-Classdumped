...
@class MiroMovieView, UIView, MiroPosterViewController, MovieController, MiroAutoEditor, UITapGestureRecognizer, AVPlayer, NSString, NSLayoutConstraint, NSNumber;
...
@property (nonatomic,retain) MiroPosterViewController * secondaryPosterViewController;                             //@synthesize secondaryPosterViewController=_secondaryPosterViewController - In the implementation block
...
-(void)setSecondaryPosterViewController:(MiroPosterViewController *)arg1 ;
-(MiroPosterViewController *)secondaryPosterViewController;
...
-(id)posterImageForCurrentBlueprintFromMemory:(id)arg1 withSize:(CGSize)arg2 ;
