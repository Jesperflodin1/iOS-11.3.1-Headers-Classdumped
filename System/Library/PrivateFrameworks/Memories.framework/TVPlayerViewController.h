...
@class AVPlayer, AVPlayerViewController, MiroAutoEditor, MiroCloudDownloader, MovieController, MiroMemory, MoodInfoPanel, DurationsInfoPanel, UICollectionView, NSArray, MiroPosterViewController, UIImage, UIView, UIActivityIndicatorView, NSString, UIProgressView, UILabel;

@interface TVPlayerViewController : UIViewController <UIGestureRecognizerDelegate, MoodDelegate, DurationDelegate> {
