...
@class MiroBlueprint, NSURL, PHAsset, NSDate, NSString, PHAssetCollection, NSArray, NSDictionary, NSObject, NSSet, MiroPickList, NSMutableDictionary, PHFetchResult;
...
@property (nonatomic,retain) PHAsset * initalKeyAsset;                            //@synthesize initalKeyAsset=_initalKeyAsset - In the implementation block
...
-(void)setInitalKeyAsset:(PHAsset *)arg1 ;
