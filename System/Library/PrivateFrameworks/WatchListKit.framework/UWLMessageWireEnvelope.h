...
@property (nonatomic,retain) NSMutableArray * liveActivityEvents;              //@synthesize liveActivityEvents=_liveActivityEvents - In the implementation block
...
-(void)setLiveActivityEvents:(NSMutableArray *)arg1 ;
