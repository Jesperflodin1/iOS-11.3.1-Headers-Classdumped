...
@class NSObject, NSUUID, NSString, NSURL, NSDictionary, NWAddressEndpoint, NWInterface, NSData, NSArray, NSSet;
...
@property (assign,nonatomic) BOOL useBoringSSL; 
...
@property (assign,nonatomic) BOOL enforceExtendedValidation; 
...
-(BOOL)copyEffectiveAuditToken:(SCD_Struct_NW23*)arg1 ;
...
-(void)setSourceApplicationWithToken:(SCD_Struct_NW23)arg1 ;
