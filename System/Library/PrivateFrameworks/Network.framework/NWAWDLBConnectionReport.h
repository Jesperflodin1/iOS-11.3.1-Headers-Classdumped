...
@interface NWAWDLBConnectionReport : PBCodable <NSCopying> {
	...
	SCD_Struct_NW20* _connectionReadyTimes;
	SCD_Struct_NW18* _resumptionFailureErrors;
	SCD_Struct_NW20* _resumptionFailureTimes;
	SCD_Struct_NW20* _resumptionSuccessTimes;
