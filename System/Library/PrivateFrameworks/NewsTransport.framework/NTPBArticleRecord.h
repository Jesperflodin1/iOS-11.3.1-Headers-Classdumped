...
@class NSString, NSMutableArray, NSData, NTPBRecordBase, COMAPPLEFELDSPARPROTOCOLLIVERPOOLCohort, NTPBDate;
...
@property (nonatomic,retain) COMAPPLEFELDSPARPROTOCOLLIVERPOOLCohort * sourceChannelCohort;              //@synthesize sourceChannelCohort=_sourceChannelCohort - In the implementation block
@property (nonatomic,readonly) BOOL hasGlobalCohort; 
@property (nonatomic,retain) COMAPPLEFELDSPARPROTOCOLLIVERPOOLCohort * globalCohort;                     //@synthesize globalCohort=_globalCohort - In the implementation block
...
-(void)setGlobalCohort:(COMAPPLEFELDSPARPROTOCOLLIVERPOOLCohort *)arg1 ;
-(void)setSourceChannelCohort:(COMAPPLEFELDSPARPROTOCOLLIVERPOOLCohort *)arg1 ;
...
-(COMAPPLEFELDSPARPROTOCOLLIVERPOOLCohort *)sourceChannelCohort;
