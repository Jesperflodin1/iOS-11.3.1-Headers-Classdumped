...
@class NTPBWidgetConfig, NSString, NTPBBinningConfig, NSMutableArray, NTPBVideoGroupsConfig, NTPBIAdConfig, NTPBPaidSubscriptionConfig, NTPBPersonalizationConfig, NTPBPersonalizationTreatment, NTPBPrefetchConfig;
...
@property (assign,nonatomic) int privateDataMigrationCleanupLevel;                                           //@synthesize privateDataMigrationCleanupLevel=_privateDataMigrationCleanupLevel - In the implementation block
