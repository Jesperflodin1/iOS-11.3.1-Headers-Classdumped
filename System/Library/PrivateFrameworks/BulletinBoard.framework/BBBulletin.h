...
@class NSString, NSSet, NSArray, BBContent, BBSectionIcon, NSDate, NSTimeZone, BBAccessoryIcon, BBSound, BBAttachmentMetadata, NSMutableDictionary, NSDictionary, BBColor, BBAction;
