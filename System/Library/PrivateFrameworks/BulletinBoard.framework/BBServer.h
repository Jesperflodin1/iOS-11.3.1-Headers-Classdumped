...
@class NSMutableDictionary, NSObject, BBDataProviderManager, NSMutableSet, BBMaskedSet, NSMutableArray, NSArray, NSDate, NSString, NSDateComponents, BBSyncService, NSXPCListener, BBDismissalSyncCache, BBBiometricResource, ABFavoritesListManager;
