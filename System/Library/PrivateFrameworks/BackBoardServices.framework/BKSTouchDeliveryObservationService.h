...
@class NSObject, NSXPCConnection, NSMapTable, NSHashTable, NSString;
...
@property (nonatomic,retain) NSMapTable * touchIdentifierToObserverLists;              //@synthesize touchIdentifierToObserverLists=_touchIdentifierToObserverLists - In the implementation block
...
-(NSMapTable *)touchIdentifierToObserverLists;
-(void)setTouchIdentifierToObserverLists:(NSMapTable *)arg1 ;
