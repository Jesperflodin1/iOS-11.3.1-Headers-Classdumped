...
@class MFSQLiteConnectionPool, MFWeakObjectCache, NSObject, MFMailMessageLibraryMigrator, NSString, NSMutableSet, MFWeakSet, _MFMailMessageLibraryStatistics, MFFileCompressionQueue, MFLibrarySearchableIndex;
