...
@class CAMPreviewView, CAMTopBar, CAMBottomBar, CUShutterButton, CAMFlipButton, NSArray, CAMFlashBadge, CAMHDRBadge, CAMFocusLockBadge, CAMLivePhotoBadge, CAMShallowDepthOfFieldBadge, CAMPortraitModeInstructionLabel, CAMPortraitModeDescriptionOverlayView, CAMFilterNameBadge, CAMShutterIndicatorView, CAMElapsedTimeView, CAMFramerateIndicatorView, CAMBurstIndicatorView, CAMTimerIndicatorView, CAMPanoramaView, CAMZoomSlider, CAMZoomControl, CAMLightingControl, CAMLightingNameBadge, CAMDisabledModeOverlayView, CAMPreviewContainerMaskingView, CAMPreviewContainerView, CAMViewfinderOpenAndCloseTransition, CAMViewfinderFlipTransition, UIView, NSString;
...
@property (nonatomic,retain) CAMLightingControl * lightingControl;                                                                          //@synthesize lightingControl=_lightingControl - In the implementation block
@property (nonatomic,retain) CAMLightingNameBadge * lightingNameBadge;                                                                      //@synthesize lightingNameBadge=_lightingNameBadge - In the implementation block
...
-(CAMTopBar *)topBar;
-(void)setLightingControl:(CAMLightingControl *)arg1 ;
-(void)setLightingNameBadge:(CAMLightingNameBadge *)arg1 ;
...
-(CAMLightingControl *)lightingControl;
...
-(CAMLightingNameBadge *)lightingNameBadge;
