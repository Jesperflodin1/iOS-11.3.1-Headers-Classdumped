...
@class CUCaptureController, CAMTimelapseController, CAMBurstIndicatorView, CAMFocusIndicatorView, NSDate, CAMFocusResult, CAMExposureResult, UITapGestureRecognizer, UILongPressGestureRecognizer, UIPanGestureRecognizer, CAMSubjectIndicatorView, CAMStageLightOverlayView, CAMMotionController, CAMPreviewView, NSString;
