...
@class CAMFlashButton, CAMElapsedTimeView, CAMHDRButton, CAMFlipButton, CAMFilterButton, CAMTimerButton, CAMIrisButton, CAMFramerateIndicatorView, UIView, NSMutableArray, CAMExpandableMenuButton, NSString;
