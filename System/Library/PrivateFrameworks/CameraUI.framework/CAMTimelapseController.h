...
@class CAMFocusResult, CAMTimelapseState, NSObject, NSCountedSet, NSMutableSet, CUCaptureController, CAMLocationController, CAMMotionController, CAMPersistenceController, CAMNebulaDaemonProxyManager, NSDate, NSString;
