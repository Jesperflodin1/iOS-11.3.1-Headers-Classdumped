...
@property (getter=isPhotoBoothApplication,nonatomic,readonly) BOOL photoBoothApplication;                                                //@synthesize photoBoothApplication=_photoBoothApplication - In the implementation block
