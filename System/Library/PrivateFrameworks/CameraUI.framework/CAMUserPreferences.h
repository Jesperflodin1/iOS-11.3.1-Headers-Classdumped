...
@property (nonatomic,readonly) BOOL capturesOnTouchDown;                                                                                              //@synthesize capturesOnTouchDown=_capturesOnTouchDown - In the implementation block
@property (nonatomic,readonly) double burstDelayAfterTouchDownCapture;                                                                                //@synthesize burstDelayAfterTouchDownCapture=_burstDelayAfterTouchDownCapture - In the implementation block
