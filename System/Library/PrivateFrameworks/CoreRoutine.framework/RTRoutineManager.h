...
@class NSXPCConnection, RTRoutineManagerRegistrantApplicationPrediction, NSString, RTEventAgentHelper, RTRoutineManagerRegistrantAction, RTRoutineManagerRegistrantScenarioTrigger, NSObject;
