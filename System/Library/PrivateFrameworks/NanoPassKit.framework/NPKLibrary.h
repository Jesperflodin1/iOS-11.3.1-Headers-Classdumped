...
@class NSObject, NSXPCConnection, NSDate, NSArray, NSMutableDictionary, NSTimer, NSMutableArray, PKPaymentPass, NSString;
...
@property (nonatomic,readonly) NSObject*<OS_dispatch_queue> updatePassDescriptionsQueue;              //@synthesize updatePassDescriptionsQueue=_updatePassDescriptionsQueue - In the implementation block
...
-(NSObject*<OS_dispatch_queue>)updatePassDescriptionsQueue;
