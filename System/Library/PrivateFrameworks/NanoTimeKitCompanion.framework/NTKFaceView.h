...
@class NSTimer, NSDate, NTKTimeTravelModuleView, UIView, UIImage, NTKExtraLargeTimeView, NSMutableDictionary, NSMutableSet, NSString, NTKContainerView, NTKFaceEditView, NTKClockIconView;
