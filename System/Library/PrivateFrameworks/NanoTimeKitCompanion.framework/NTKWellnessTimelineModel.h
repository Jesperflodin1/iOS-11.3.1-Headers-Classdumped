...
@class HKHealthStore, HKQuantityType, HKUnit, HKObserverQuery, HKAnchoredObjectQuery, HKQueryAnchor, _HKCurrentActivitySummaryQuery, HKCurrentActivityCacheQuery, NSObject, HKActivitySummary, HKSortedSampleArray, NSArray, NSMutableDictionary, _HKDelayedOperation, NSHashTable, NSDate;
