...
@class HUQuickControlSliderGestureTransformer, UILongPressGestureRecognizer, UITapGestureRecognizer, HUElasticApplier, HUDisplayLinkApplier, HUQuickControlViewProfile, NSString;
...
-(CGSize)modelValue;
-(void)_updateModelValue:(CGSize)arg1 notifyDelegate:(BOOL)arg2 ;
...
-(CGSize)_boundedRangeForRange:(CGSize)arg1 ;
