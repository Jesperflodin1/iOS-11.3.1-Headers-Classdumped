...
@interface HUDynamicScrollingOptions : NSObject {
	...
	SCD_Struct_HU9 _textScaleSetting;
...
@property (assign,nonatomic) SCD_Struct_HU9 textScaleSetting;              //@synthesize textScaleSetting=_textScaleSetting - In the implementation block
...
-(void)setTextScaleSetting:(SCD_Struct_HU9)arg1 ;
-(SCD_Struct_HU9)textScaleSetting;
@end
