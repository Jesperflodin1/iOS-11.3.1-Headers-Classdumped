...
-(id)_writeHEIFImage:(CGImageSourceRef)arg1 sourceURL:(id)arg2 inFormat:(CFStringRef)arg3 withMaxByteSize:(unsigned long long)arg4 maxDimension:(unsigned long long)arg5 actualSize:(unsigned long long*)arg6 startingLengthIndex:(int)arg7 usedLengthIndex:(int*)arg8 ;
-(id)_writeWideGamutImage:(CGImageSourceRef)arg1 sourceURL:(id)arg2 inFormat:(CFStringRef)arg3 withMaxByteSize:(unsigned long long)arg4 maxDimension:(unsigned long long)arg5 actualSize:(unsigned long long*)arg6 startingLengthIndex:(int)arg7 usedLengthIndex:(int*)arg8 ;
