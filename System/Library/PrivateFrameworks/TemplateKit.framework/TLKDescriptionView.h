...
@property (retain) TLKMultilineText * text;                                       //@synthesize text=_text - In the implementation block
@property (retain) TLKMultilineText * title;                                      //@synthesize title=_title - In the implementation block
@property (retain) NSString * moreButtonText;                                     //@synthesize moreButtonText=_moreButtonText - In the implementation block
