...
@interface VKGGLDebugTileData : NSObject {
	...
	unique_ptr<ggl::Debug::BaseMesh, std::__1::default_delete<ggl::Debug::BaseMesh> >* _venueOutlineMesh;
	unique_ptr<ggl::Debug::BaseMesh, std::__1::default_delete<ggl::Debug::BaseMesh> >* _venueBuildingOutlineMesh;
...
@property (nonatomic,readonly) BaseMesh* venueOutlineMesh; 
@property (nonatomic,readonly) BaseMesh* venueBuildingOutlineMesh; 
...
@property (nonatomic,readonly) unsigned long long venueOutlinesCount;                //@synthesize venueOutlinesCount=_venueOutlinesCount - In the implementation block
...
-(BaseMesh*)venueOutlineMesh;
-(BaseMesh*)venueBuildingOutlineMesh;
