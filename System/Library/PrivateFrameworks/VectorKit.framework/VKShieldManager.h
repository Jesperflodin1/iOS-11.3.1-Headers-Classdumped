...
-(id)artworkForShieldType:(long long)arg1 textLength:(unsigned long long)arg2 contentScale:(double)arg3 resourceNames:(id)arg4 style:(const shared_ptr<const md::GenericShieldStyleInfo>*)arg5 size:(long long)arg6 idiom:(long long)arg7 numberOfLines:(unsigned long long)arg8 colors:(SCD_Struct_VK94*)arg9 featureType:(unsigned long long)arg10 variant:(unsigned long long)arg11 ;
-(id)artworkForShieldName:(id)arg1 textLength:(unsigned long long)arg2 contentScale:(double)arg3 resourceNames:(id)arg4 size:(long long)arg5 idiom:(long long)arg6 numberOfLines:(unsigned long long)arg7 colors:(SCD_Struct_VK94*)arg8 ;
-(id)artworkForShieldType:(long long)arg1 textLength:(unsigned long long)arg2 contentScale:(double)arg3 size:(long long)arg4 idiom:(long long)arg5 mapRect:(SCD_Struct_VK123)arg6 colors:(SCD_Struct_VK94*)arg7 featureType:(unsigned long long)arg8 variant:(unsigned long long)arg9 ;
-(id)imageForShieldType:(long long)arg1 shieldText:(id)arg2 contentScale:(double)arg3 size:(long long)arg4 idiom:(long long)arg5 colors:(SCD_Struct_VK94*)arg6 featureType:(unsigned long long)arg7 variant:(unsigned long long)arg8 ;
-(id)artworkForShieldType:(long long)arg1 textLength:(unsigned long long)arg2 contentScale:(double)arg3 size:(long long)arg4 idiom:(long long)arg5 colors:(SCD_Struct_VK94*)arg6 featureType:(unsigned long long)arg7 variant:(unsigned long long)arg8 ;
