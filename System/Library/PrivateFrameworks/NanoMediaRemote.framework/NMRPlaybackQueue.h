...
@interface NMRPlaybackQueue : NSObject {
	...
	NMROrigin* _origin;
	SCD_Struct_NM11 _observedRange;
...
@property (assign,nonatomic) SCD_Struct_NM11 observedRange;                             //@synthesize observedRange=_observedRange - In the implementation block
...
-(void*)_mediaRemotePlaybackQueueWithRange:(SCD_Struct_NM11)arg1 includeMetadata:(BOOL)arg2 ;
-(id)_metadataForItemWithIdentifier:(id)arg1 ;
-(SCD_Struct_NM11)observedRange;
...
-(void*)copyMediaRemotePlaybackQueueWithRange:(SCD_Struct_NM11)arg1 includeMetadata:(BOOL)arg2 ;
...
-(SCD_Struct_NM11)_rangeOfItemsNeedingMetadataForMediaRemoteQueue:(void*)arg1 ;
-(BOOL)_needsUpdateForMediaRemoteQueue:(void*)arg1 ;
-(void)setObservedRange:(SCD_Struct_NM11)arg1 ;
@end
