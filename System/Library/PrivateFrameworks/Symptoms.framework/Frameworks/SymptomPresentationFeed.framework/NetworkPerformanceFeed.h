...
-(id)_routeMetricsPresentationFromRoll:(id)arg1 source:(route_stats_stuct*)arg2 since:(id)arg3 isKnownGood:(id)arg4 isLowInternetDL:(id)arg5 isLowInternetUL:(id)arg6 ;
