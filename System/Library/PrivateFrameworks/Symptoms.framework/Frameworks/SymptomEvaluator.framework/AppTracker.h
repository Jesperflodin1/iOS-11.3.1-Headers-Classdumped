...
@class SFActivityBitmapMatrix, NSString, NSDate, TrackerPolicy;
...
@interface AppTracker : NSObject <ManagedEventInfoProtocol> {
	...
	SFActivityBitmapMatrix* _backgroundActivityBitmapMatrix;
	NSString* _userName;
...
@property (retain) SFActivityBitmapMatrix * backgroundActivityBitmapMatrix;              //@synthesize backgroundActivityBitmapMatrix=_backgroundActivityBitmapMatrix - In the implementation block
...
-(void)setBackgroundActivityBitmapMatrix:(SFActivityBitmapMatrix *)arg1 ;
...
-(SFActivityBitmapMatrix *)backgroundActivityBitmapMatrix;
