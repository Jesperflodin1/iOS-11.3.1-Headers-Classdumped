...
#import <libobjc.A.dylib/TCPDumpProbeDelegate.h>
...
@interface ProbeManager : NSObject <BonjourProbeDelegate, ICMPPingProbeDelegate, AWDLPeerProbeDelegate, TCPDumpProbeDelegate, CoreTelephonyDumpProbeDelegate> {
...
-(void)tcpDumpComplete:(id)arg1 outputFiles:(id)arg2 status:(unsigned)arg3 ;
...
-(void)removeProbeGeneratedFiles:(id)arg1 ;
