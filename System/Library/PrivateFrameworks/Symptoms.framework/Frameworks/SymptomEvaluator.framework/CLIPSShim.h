...
@interface CLIPSShim : NSObject {
	...
	SCD_Struct_CL51* _consoleNameRegex;
	SCD_Struct_CL51* _dumpStringRegex;
...
@property (assign,nonatomic) SCD_Struct_CL52* consoleNameRegex;                    //@synthesize consoleNameRegex=_consoleNameRegex - In the implementation block
@property (assign,nonatomic) SCD_Struct_CL52* dumpStringRegex;                     //@synthesize dumpStringRegex=_dumpStringRegex - In the implementation block
...
-(void)updateModuleInfoForModule:(id)arg1 value:(id)arg2 forSlot:(id)arg3 ;
...
-(SCD_Struct_CL52*)consoleNameRegex;
-(void)setConsoleNameRegex:(SCD_Struct_CL52*)arg1 ;
-(SCD_Struct_CL52*)dumpStringRegex;
-(void)setDumpStringRegex:(SCD_Struct_CL52*)arg1 ;
