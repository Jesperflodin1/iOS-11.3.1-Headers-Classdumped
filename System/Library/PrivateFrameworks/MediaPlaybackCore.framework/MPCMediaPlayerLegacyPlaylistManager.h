...
@class NSMutableIndexSet, MPMutableBidirectionalDictionary, NSObject, MPMusicPlayerControllerQueue, NSMapTable, MPQueueFeeder, NSMutableArray, MPAVItem, _MPCAVItemSourceContext, _MPCAVPlaylistIteration, NSString;
