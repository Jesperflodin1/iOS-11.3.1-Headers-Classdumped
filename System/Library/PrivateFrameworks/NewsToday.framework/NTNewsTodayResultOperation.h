...
@class NSDate, NTCatchUpOperationForYouFetchInfo, NTTodayResults, NSDictionary, NTPBTodayResultOperationFetchInfo, NSObject;
...
@property (nonatomic,retain) NSObject * resultHoldToken;                                     //@synthesize resultHoldToken=_resultHoldToken - In the implementation block
-(id)init;
...
-(void)setResultHoldToken:(NSObject *)arg1 ;
...
-(NSObject *)resultHoldToken;
-(void)_registerForYouFetchWithForYouFetchInfo:(id)arg1 ;
-(void)_finalizeTodayResultsWithSectionDescriptors:(id)arg1 catchUpOperationResultsBySectionDescriptor:(id)arg2 itemIDsOfLeadingCells:(id)arg3 slotAllocationByDynamicSlotItemID:(id)arg4 appConfiguration:(id)arg5 feedPersonalizer:(id)arg6 completion:(/*^block*/id)arg7 ;
-(NSDate *)filterDate;
