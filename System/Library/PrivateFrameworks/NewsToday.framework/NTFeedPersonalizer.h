...
@protocol FRReadonlyPersonalizationAggregateStore, FCTodayPrivateData, FRRingBufferContainer;
...
@property (nonatomic,retain) id<FRReadonlyPersonalizationAggregateStore> readonlyPersonalizationAggregateStore;              //@synthesize readonlyPersonalizationAggregateStore=_readonlyPersonalizationAggregateStore - In the implementation block
...
-(id<FRReadonlyPersonalizationAggregateStore>)readonlyPersonalizationAggregateStore;
-(void)setReadonlyPersonalizationAggregateStore:(id<FRReadonlyPersonalizationAggregateStore>)arg1 ;
