...
@class NUArticleExcerptTraits, UIImageView, UILabel, WKWebView, NUArticleExcerptReadMoreButton, UIScrollView, UIView, NUMultiDelegate, NSString;
...
@property (nonatomic,readonly) NUMultiDelegate * multiDelegate;                              //@synthesize multiDelegate=_multiDelegate - In the implementation block
