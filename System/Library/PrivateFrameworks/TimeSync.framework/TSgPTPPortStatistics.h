...
@property (nonatomic,readonly) long long portType;                                             //@synthesize portType=_portType - In the implementation block
@property (nonatomic,readonly) long long portRole;                                             //@synthesize portRole=_portRole - In the implementation block
