...
@class NSRecursiveLock, IMDAccount, NSMutableArray, NSMutableDictionary, NSMutableSet, IMTimer, NSTimer, IMTimingCollection, IMConnectionMonitor, NSString, IMSystemProxySettingsFetcher, IMDService, NSArray, NSDictionary;
