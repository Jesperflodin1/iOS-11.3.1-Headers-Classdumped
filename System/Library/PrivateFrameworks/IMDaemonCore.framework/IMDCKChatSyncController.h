...
-(void)_processFetchRecordChangesCompleted:(id)arg1 completion:(/*^block*/id)arg2 isUsingStingRay:(BOOL)arg3 ;
...
-(void)__syncChatsWithCloudKit:(long long)arg1 withCompletion:(/*^block*/id)arg2 ;
-(BOOL)_eligibleForTruthZone;
-(void)_syncChatsWithCloudKitWithCompletion:(/*^block*/id)arg1 ;
