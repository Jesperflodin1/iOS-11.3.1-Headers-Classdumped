...
@property (nonatomic,readonly) NSNumber * payloadAllowDataRoaming; 
@property (nonatomic,readonly) NSNumber * payloadAllowVoiceRoaming; 
@property (nonatomic,readonly) NSNumber * payloadAllowPersonalHotspot; 
@property (nonatomic,readonly) NSNumber * payloadAllowGlobalBackgroundFetchWhenRoaming; 
@property (nonatomic,readonly) NSNumber * payloadAllowCellularPlanModification; 
