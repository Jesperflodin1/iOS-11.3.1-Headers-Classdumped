...
@property (nonatomic,readonly) NSNumber * payloadAllowBookstore; 
@property (nonatomic,readonly) NSNumber * payloadAllowBookstoreErotica; 
@property (nonatomic,readonly) NSNumber * payloadAllowEnterpriseBookBackup; 
@property (nonatomic,readonly) NSNumber * payloadAllowEnterpriseBookMetadataSync; 
