...
@property (nonatomic,readonly) NSNumber * payloadAllowPredictiveKeyboard; 
@property (nonatomic,readonly) NSNumber * payloadAllowAutoCorrection; 
@property (nonatomic,readonly) NSNumber * payloadAllowSpellCheck; 
@property (nonatomic,readonly) NSNumber * payloadAllowKeyboardShortcuts; 
