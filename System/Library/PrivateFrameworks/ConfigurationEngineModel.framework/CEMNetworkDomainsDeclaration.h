...
@property (nonatomic,readonly) NSArray * payloadEmailDomains; 
@property (nonatomic,readonly) NSArray * payloadWebDomains; 
@property (nonatomic,readonly) NSArray * payloadSafariPasswordAutoFillDomains; 
