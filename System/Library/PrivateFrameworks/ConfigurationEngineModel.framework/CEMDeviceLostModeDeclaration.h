...
@property (nonatomic,readonly) NSNumber * payloadEnable; 
@property (nonatomic,readonly) NSString * payloadMessage; 
@property (nonatomic,readonly) NSString * payloadPhoneNumber; 
@property (nonatomic,readonly) NSString * payloadFootnote; 
