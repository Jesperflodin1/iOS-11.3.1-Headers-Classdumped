...
@property (nonatomic,readonly) NSString * payloadOrganizationName; 
@property (nonatomic,readonly) NSString * payloadOrganizationAddress; 
@property (nonatomic,readonly) NSString * payloadOrganizationPhone; 
@property (nonatomic,readonly) NSString * payloadOrganizationEmail; 
@property (nonatomic,readonly) NSString * payloadOrganizationMagic; 
