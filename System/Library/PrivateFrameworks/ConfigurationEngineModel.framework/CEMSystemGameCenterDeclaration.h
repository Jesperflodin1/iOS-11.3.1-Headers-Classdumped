...
@property (nonatomic,readonly) NSNumber * payloadAllowGameCenter; 
@property (nonatomic,readonly) NSNumber * payloadAllowMultiplayerGaming; 
@property (nonatomic,readonly) NSNumber * payloadAllowAddingGameCenterFriends; 
