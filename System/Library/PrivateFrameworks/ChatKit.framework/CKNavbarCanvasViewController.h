...
@class CKNavigationBarCanvasView, NSString, CKConversation, CKAvatarPickerViewController, CKLabel, CKCanvasBackButtonView, UIButton, UINavigationController, CNContactStore;
