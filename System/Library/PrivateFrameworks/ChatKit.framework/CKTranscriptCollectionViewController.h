...
@class NSIndexPath, NSArray, CKConversation, UIView, NSObject, NSIndexSet, CKImpactEffectManager, CKFullScreenEffectManager, NSString, UITapGestureRecognizer, CKTranscriptCollectionView, CKAudioController, CKPluginPlaybackManager, NSMutableSet, IMChat;
...
@property (nonatomic,copy) NSArray * bulletins;                                                             //@synthesize bulletins=_bulletins - In the implementation block
...
-(id)initWithConversation:(id)arg1 bulletins:(id)arg2 balloonMaxWidth:(double)arg3 marginInsets:(UIEdgeInsets)arg4 ;
