...
@class UIView, CABackdropLayer, CALayer, CKFullScreenEffectManager, NSArray, NSMutableDictionary, UIPageControl, UILabel, UIFont, UICollectionView, _UIBackdropView, NSLayoutConstraint, UIPanGestureRecognizer, CKChatControllerDummyAnimator, UIButton, CKBalloonView, NSMutableArray, UISegmentedControl, NSString;
