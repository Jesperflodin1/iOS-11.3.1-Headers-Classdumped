...
@class CKImmediatePanGestureRecognizer, UIViewPropertyAnimator, UIViewController, CKBrowserTransitionCoordinator, UIView, UICollectionView, UICollectionViewFlowLayout, NSMutableDictionary, UILongPressGestureRecognizer, CKBrowserSwitcherScrollPreventer, IMScheduledUpdater, IMBalloonPlugin, CKAppGrabberView, CKBrowserSwitcherFooterView, CKBrowserSwitcherFooterViewDataSource, NSArray, NSDate, NSString;
...
@property (nonatomic,retain) UILongPressGestureRecognizer * horizontalSwipePreventer;                                                          //@synthesize horizontalSwipePreventer=_horizontalSwipePreventer - In the implementation block
...
@property (nonatomic,retain) CKBrowserSwitcherFooterViewDataSource * footerViewDataSource;                                                     //@synthesize footerViewDataSource=_footerViewDataSource - In the implementation block
...
-(void)setHorizontalSwipePreventer:(UILongPressGestureRecognizer *)arg1 ;
...
-(void)setFooterViewDataSource:(CKBrowserSwitcherFooterViewDataSource *)arg1 ;
...
-(UILongPressGestureRecognizer *)horizontalSwipePreventer;
...
-(CKBrowserSwitcherFooterViewDataSource *)footerViewDataSource;
