...
#import <libobjc.A.dylib/DDMoneyActionDelegate.h>
...
@class IMBalloonPlugin, IMBalloonPluginDataSource, UIViewController, CKMessageEntryView, CKKeyboardContentViewController, CKBrowserSwitcherViewController, NSDate, CKDeviceOrientationManager, UINavigationController, IMScheduledUpdater, CKScheduledUpdater, CKHandwritingPresentationController, UITextInputPayloadController, NSString;
