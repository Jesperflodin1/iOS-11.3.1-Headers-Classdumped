...
@class NSArray, CKConversation, CKMessageEntryContentView, CKMessageEntryWaveformView, CKEntryViewButton, UIView, UILongPressGestureRecognizer, UIPreviewInteraction, CKActionMenuGestureRecognizerButton, CKInlineAudioReplyButtonController, UILabel, _UIBackdropView, CKAudioRecorder, CKComposition, CKActionMenuController, CKMessageEntryRecordedAudioView, CKMessageEntryAudioHintView, UIInputContextHistory, CKBrowserSwitcherFooterView, CAMShutterButton, CKScheduledUpdater, UISwipeGestureRecognizer, NSString;
...
@property (assign,getter=shouldShowAppStrip,nonatomic) BOOL showAppStrip;                                               //@synthesize showAppStrip=_showAppStrip - In the implementation block
