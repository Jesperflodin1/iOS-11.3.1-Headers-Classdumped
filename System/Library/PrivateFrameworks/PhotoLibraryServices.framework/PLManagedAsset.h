...
@class NSManagedObjectID, NSString, NSDate, NSSet, NSURL, CLLocation, NSError, UIImage, NSDictionary, NSData, PLCloudFeedAssetsEntry, NSNumber, NSOrderedSet, PLAdditionalAssetAttributes, PLMoment, PLCloudMaster, NSManagedObject, PLFaceCrop, NSArray;

@interface PLManagedAsset : PLManagedObject <PLPTPTransferableAsset, PLSyncableAsset, UIActivityItemSource, PLMomentAssetData_Private, _PLImageLoadingAsset> {
...
@property (assign,nonatomic) SCD_Struct_PL10 photoIrisStillDisplayTime; 
@property (assign,nonatomic) SCD_Struct_PL10 photoIrisVideoDuration; 
...
-(void)setPhotoIrisVideoDuration:(SCD_Struct_PL10)arg1 ;
-(void)setPhotoIrisStillDisplayTime:(SCD_Struct_PL10)arg1 ;
-(id)_sidecarFileMatchingUTI:(CFStringRef)arg1 requireExactMatch:(BOOL)arg2 requireSort:(BOOL)arg3 ;
-(void)updatePhotoIrisMetadataWithMediaGroupUUID:(id)arg1 videoDuration:(SCD_Struct_PL10)arg2 stillDisplayTime:(SCD_Struct_PL10)arg3 ;
