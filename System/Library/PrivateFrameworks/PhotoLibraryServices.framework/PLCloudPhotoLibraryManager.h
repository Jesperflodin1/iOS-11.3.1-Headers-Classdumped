...
@class PLCloudBatchUploader, PLCloudBatchDownloader, NSString, NSObject, PLBatterySaverWatcher, PLPhotoLibrary, CPLLibraryManager, PLCloudTaskManager, PLCloudResourceManager, NSDate, PFCoalescer, PLCloudInMemoryTaskManager, PLCloudPhotoLibraryUploadTracker, NSNumber;
