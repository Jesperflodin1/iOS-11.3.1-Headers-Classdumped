...
@property (assign,nonatomic) BOOL shouldRunUserInfluence;                                                            //@synthesize shouldRunUserInfluence=_shouldRunUserInfluence - In the implementation block
...
@property (assign,nonatomic) BOOL hasLocationsOfInterestInformation;                                                 //@synthesize hasLocationsOfInterestInformation=_hasLocationsOfInterestInformation - In the implementation block
