...
@class NSString, NSNumber, CLLocation, NSData, NSDate, PLManagedAsset, NSSet, PLUnmanagedAdjustment, PLAssetDescription;
...
+(id)newExtraDurationDataFromStillDisplayTime:(SCD_Struct_PL26)arg1 videoDuration:(SCD_Struct_PL26)arg2 ;
+(void)fromExtraDurationData:(id)arg1 getStillDisplayTime:(SCD_Struct_PL26*)arg2 videoDuration:(SCD_Struct_PL26*)arg3 ;
