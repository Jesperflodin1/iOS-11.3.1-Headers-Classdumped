...
@class NSString, TUCallProvider, TUHandle, TUCallProviderManager, CNContactStore, IDSDestination, NSURL, NSUserActivity, NSArray;
...
@property (assign,nonatomic) int callIdentifier; 
