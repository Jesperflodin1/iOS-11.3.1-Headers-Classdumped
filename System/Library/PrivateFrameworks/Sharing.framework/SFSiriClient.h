...
@class SFSiriRequest, NSObject, NSString, VSSpeechSynthesizer, SVXDeviceSetupContext, SVXClientServiceManager, SVXDeviceSetupFlowScene;
...
-(void)_speakText:(id)arg1 flags:(unsigned)arg2 rate:(double)arg3 delay:(double)arg4 startHandler:(/*^block*/id)arg5 completion:(/*^block*/id)arg6 ;
