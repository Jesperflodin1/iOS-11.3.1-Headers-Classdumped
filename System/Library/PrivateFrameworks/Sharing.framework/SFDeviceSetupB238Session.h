...
@class RPCompanionLinkClient, AVAudioSession, AVAudioPlayer, ACAccountStore, ACAccount, NSString, SSAccount, NSObject, NSArray, HMAccessory, SFSession, APCListener, SFDeviceOperationWiFiSetup, TRSession, NSMutableArray, TROperationQueue, NSSet, SFDeviceOperationHomeKitSetup, NSDictionary, SFDevice, UIViewController, HMHome;
...
-(void)_speakPasscodeWithInstructions:(id)arg1 completion:(/*^block*/id)arg2 ;
