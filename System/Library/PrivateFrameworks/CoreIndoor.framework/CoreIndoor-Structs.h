...
typedef struct {
	...
	BOOL isFitnessMatch;
	int matchQuality;
	SCD_Struct_CL27 matchCoordinate;
	double matchCourse;
	int matchFormOfWay;
	int matchRoadClass;
	BOOL matchShifted;
	SCD_Struct_CL27 pressure;
	float undulation;
	SCD_Struct_CL27 specialCoordinate;
...
typedef struct {
	...
	BOOL field9;
	int field10;
	SCD_Struct_CL27 field11;
	double field12;
	int field13;
	int field14;
	BOOL field15;
	SCD_Struct_CL27 field16;
	float field17;
	SCD_Struct_CL27 field18;
	double field19;
	double field20;
	int field21;
} SCD_Struct_CL31;
