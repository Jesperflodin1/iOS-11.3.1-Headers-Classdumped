...
@class NSString, NSData, NSDictionary, HAPAccessoryServerBrowserIP, NSArray, NSMutableArray, HAPAccessory, HAPHTTPClient, HAPAuthSession, HAPAccessoryProtocolInfo, HMFBlockOperation, NSOperationQueue, HAPWACClient, HMFTimer, HMFNetMonitor;
