...
@interface PHAVisionServicePersistenceDelegate : NSObject <PVPersistenceDelegate> {
	...
	unsigned _activeFaceAlgorithmVersion;
	BOOL _personBuilderMergeCandidatesDisabled;

}

@property (assign,nonatomic) unsigned activeFaceAlgorithmVersion;              //@synthesize activeFaceAlgorithmVersion=_activeFaceAlgorithmVersion - In the implementation block
...
-(void)buildPersonsWithFaceClusterer:(id)arg1 keyFaceUpdateBlock:(/*^block*/id)arg2 canceler:(id)arg3 context:(id)arg4 ;
...
-(void)setActiveFaceAlgorithmVersion:(unsigned)arg1 ;
