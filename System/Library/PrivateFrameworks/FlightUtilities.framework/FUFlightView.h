...
@class FUPlaneTrackerAnnotationView, NSMutableArray, FUFLightTrack, UIPageViewController, UIScrollView, NSLayoutConstraint, NSArray, MKMapView, UIVisualEffectView, UIView, UIPageControl, NSString;
...
@property (assign,nonatomic,__weak) UIView * borderLineViewLandscape;                                //@synthesize borderLineViewLandscape=_borderLineViewLandscape - In the implementation block
@property (assign,nonatomic,__weak) UIView * borderLineViewPortrait;                                 //@synthesize borderLineViewPortrait=_borderLineViewPortrait - In the implementation block
