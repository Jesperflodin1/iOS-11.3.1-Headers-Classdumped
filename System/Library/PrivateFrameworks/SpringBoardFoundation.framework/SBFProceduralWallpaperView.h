...
@property (nonatomic,readonly) id<SBFProceduralWallpaper> proceduralWallpaper;              //@synthesize proceduralWallpaper=_proceduralWallpaper - In the implementation block
...
-(id)initWithFrame:(CGRect)arg1 proceduralWallpaper:(id)arg2 options:(id)arg3 variant:(long long)arg4 wallpaperSettingsProvider:(id)arg5 ;
