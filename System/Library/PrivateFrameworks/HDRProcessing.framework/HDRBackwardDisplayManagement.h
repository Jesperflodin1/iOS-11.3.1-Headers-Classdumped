...
@interface HDRBackwardDisplayManagement : NSObject {
	...
	id<MTLRenderPipelineState> _BKDM_SDRUIOnly_ShaderDegamma[8];
...
-(void)attatchInfoFrame:(SCD_Struct_HD6*)arg1 toOutputSurface:(IOSurfaceRef)arg2 ;
...
-(void)generateMetaAndConfig:(id)arg1 inputSurface:(IOSurfaceRef)arg2 outputSurface:(IOSurfaceRef)arg3 payLoad:(/*function pointer*/void**)arg4 payloadLength:(unsigned*)arg5 dmCfg:(/*function pointer*/void**)arg6 ;
-(void)fillScalingTable_SDR2HDR:(SCD_Struct_HD6*)arg1 target_White:(float)arg2 target_Black:(float)arg3 ;
-(BOOL)updateConfigFromMetadata:(SCD_Struct_HD6*)arg1 uiScaleFactor:(float)arg2 width:(int)arg3 background:(SCD_Struct_HD7*)arg4 hdrVideoOnly:(BOOL)arg5 hdr10TV:(BOOL)arg6 sdrOnly:(BOOL)arg7 ;
-(void)fillScalingTable_YUVTM:(SCD_Struct_HD6*)arg1 targetwhite:(float)arg2 targetblack:(float)arg3 satBoost:(float)arg4 scalingFactor:(BOOL)arg5 sdrOnly:(BOOL)arg6 ;
-(void)fillInverseScalingFactorTableFromDMConfig:(SCD_Struct_HD6*)arg1 ;
-(void)adjustL1MetaData:(SCD_Struct_HD8*)arg1 HDRUIBlending:(BOOL)arg2 ;
-(void)packetizeMetadata:(SCD_Struct_HD8*)arg1 length:(int)arg2 into:(int)arg3 onSurface:(IOSurfaceRef)arg4 ;
...
-(void)setupTexturesWithInput:(IOSurfaceRef)arg1 VideoSRGB:(BOOL)arg2 UI:(IOSurfaceRef)arg3 UISRGB:(BOOL)arg4 Output:(IOSurfaceRef)arg5 PixelPerThread:(int)arg6 ;
