...
-(void)updateMembers:(id)arg1 forGroupID:(id)arg2 isTriggeredLocally:(BOOL)arg3 forSessionWithUniqueID:(id)arg4;
-(void)joinGroupSession:(id)arg1 participantInfo:(id)arg2;
-(void)leaveGroupSession:(id)arg1 participantInfo:(id)arg2;
-(void)setupNewStatusNotifierWithConfiguration:(id)arg1;
-(void)cleanupGroupStatusNotifier:(id)arg1;
-(id)participantsForGroupID:(id)arg1 forNotifierWithUniqueID:(id)arg2;
