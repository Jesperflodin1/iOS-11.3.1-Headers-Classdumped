...
-(void)p_selection:(id)arg1 toGlyphRange:(SCD_Struct_TS110*)arg2 ;
-(unsigned long long)p_LeftCharForInsertion:(const SCD_Struct_TS110*)arg1 ;
-(const TSWPLineFragment*)p_lineFragmentWithCaretInfo:(SCD_Struct_TS111*)arg1 forSelection:(id)arg2 ;
