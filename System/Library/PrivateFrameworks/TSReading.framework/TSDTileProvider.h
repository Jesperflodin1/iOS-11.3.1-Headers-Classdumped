...
@interface TSDTileProvider : NSObject <CALayerDelegate> {
	...
	SCD_Struct_TS84 mVisibleTileRect;

}

@property (assign) SCD_Struct_TS84 visibleTileRect; 
...
-(SCD_Struct_TS84)visibleTileRect;
-(id)p_bucketKey;
-(BOOL)isTargetOpaque;
...
-(void)setVisibleTileRect:(SCD_Struct_TS84)arg1 ;
@end
