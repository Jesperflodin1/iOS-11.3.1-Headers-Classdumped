...
-(SCD_Struct_TS115)lineMetricsAtPoint:(CGPoint)arg1 ;
...
-(SCD_Struct_TS115)lineMetricsAtCharIndex:(unsigned long long)arg1 ;
...
-(SCD_Struct_TS135)wordMetricsAtCharIndex:(unsigned long long)arg1 ;
