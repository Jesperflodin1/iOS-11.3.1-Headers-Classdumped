...
+(unsigned)tableAreaForCellID:(SCD_Struct_TS139)arg1 inTableWithHeaderColumns:(unsigned short)arg2 headerRows:(unsigned short)arg3 footerRows:(unsigned short)arg4 totalRows:(unsigned short)arg5 ;
+(SCD_Struct_TS141)cellRangeForTableArea:(unsigned)arg1 givenTableSize:(SCD_Struct_TS121)arg2 numberOfHeaderRows:(unsigned short)arg3 numberOfFooterRows:(unsigned short)arg4 numberOfHeaderColumns:(unsigned short)arg5 ;
-(id)init;
-(void)dealloc;
-(unsigned short)numberOfColumns;
-(unsigned short)numberOfRows;
-(SCD_Struct_TS141)range;
...
-(SCD_Struct_TS141)headerRowRange;
-(SCD_Struct_TS141)footerRowRange;
-(SCD_Struct_TS141)headerColumnRange;
-(SCD_Struct_TS141)bodyColumnRange;
-(void)defaultStrokesForCellID:(SCD_Struct_TS139)arg1 inTableWithHeaderColumns:(unsigned short)arg2 headerRows:(unsigned short)arg3 footerRows:(unsigned short)arg4 totalColumns:(unsigned short)arg5 totalRows:(unsigned short)arg6 tableArea:(unsigned)arg7 outTopStroke:(id*)arg8 outLeftStroke:(id*)arg9 outBottomStroke:(id*)arg10 outRightStroke:(id*)arg11 ;
...
-(void)p_scaleStrokesOnCell:(id)arg1 atCellID:(SCD_Struct_TS139)arg2 transformedObjects:(id)arg3 scale:(double)arg4 ;
...
-(SCD_Struct_TS141)cellRangeForTableArea:(unsigned)arg1 ;
...
-(void)defaultStrokesForCellID:(SCD_Struct_TS139)arg1 outTopStroke:(id*)arg2 outLeftStroke:(id*)arg3 outBottomStroke:(id*)arg4 outRightStroke:(id*)arg5 ;
-(id)cellRegionWithConditionalStyleMatchingCell:(SCD_Struct_TS139)arg1 ;
-(void)moveCalcEngineReferencesFromSourceTable:(CFUUIDRef)arg1 sourceRange:(SCD_Struct_TS141)arg2 sourceOffset:(SCD_Struct_TS85)arg3 ;
-(void)validateStyles;
-(void)private_validateMergeCellsPedantically;
-(SCD_Struct_TS141)minPopulatedCellRange;
