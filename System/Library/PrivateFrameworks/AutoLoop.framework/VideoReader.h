...
@interface VideoReader : NSObject {
	...
	SCD_Struct_Pr1 trackStartT;
	SCD_Struct_Pr1 trackLengthT;
	SCD_Struct_Pr1 readStartT;
	SCD_Struct_Pr1 readLengthT;
	SCD_Struct_Pr1 minFrameDuration;
	SCD_Struct_Pr1 lastPresentationTime;
...
@property (readonly) SCD_Struct_Pr1 trackStartT; 
@property (readonly) SCD_Struct_Pr1 trackLengthT; 
@property (assign) float readStart; 
@property (assign) float readLength; 
@property (assign) SCD_Struct_Pr1 readStartT; 
@property (assign) SCD_Struct_Pr1 readLengthT; 
@property (readonly) int timeScale; 
@property (readonly) float fps; 
@property (readonly) SCD_Struct_Pr1 minFrameDuration; 
...
@property (readonly) SCD_Struct_Pr1 lastPresentationTime; 
...
-(void)setReadStartT:(SCD_Struct_Pr1)arg1 ;
...
-(int)getFrameAtTime:(SCD_Struct_Pr1)arg1 exactTime:(BOOL)arg2 frame:(opaqueCMSampleBuffer*)arg3 ;
...
-(SCD_Struct_Pr1)readStartT;
-(SCD_Struct_Pr1)readLengthT;
-(void)setReadLengthT:(SCD_Struct_Pr1)arg1 ;
-(float)fps;
-(BOOL)fullRangeVideo;
-(SCD_Struct_Pr1)lastPresentationTime;
-(AVAssetReaderOutput *)trackOutput;
