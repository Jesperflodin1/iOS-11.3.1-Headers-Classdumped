...
@class NSMutableDictionary, UIViewController, NSMutableSet, MediaControlsCollectionViewCountData, _MediaControlsTapHoldGestureRecognizer, UIScrollView, NSArray, NSIndexSet, NSString;
