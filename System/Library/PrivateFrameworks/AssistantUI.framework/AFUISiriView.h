...
@class UIView, _UIBackdropView, SiriUIAudioRoutePickerButton, SiriUIHelpButton, SiriUIContentButton, SiriUIConfiguration, SiriUIVisualEffectView, UIImageView, UILabel, NSString;
...
@property (assign,nonatomic) BOOL flamesViewPaused;                                             //@synthesize flamesViewPaused=_flamesViewPaused - In the implementation block
