...
@class NSObject, AFUIStateMachine, AFUISpeechSynthesis, NSMutableSet, AFUIAppIntentDeliverer, AFSettingsConnection, AFConnectionUserInteractionAssertion, AFUISiriSessionInfo, AFConnection, NSString;
...
-(void)assistantConnection:(id)arg1 handleIntent:(id)arg2 inBackgroundAppWithBundleId:(id)arg3 reply:(/*^block*/id)arg4 ;
