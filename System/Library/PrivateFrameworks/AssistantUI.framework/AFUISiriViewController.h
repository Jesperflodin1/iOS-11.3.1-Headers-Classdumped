...
@class AFUIDelayedActionCommandCache, SiriUIConfiguration, SACarPlaySupportedOEMAppIdList, NSString, NSObject, SiriUIKeyboardView, NSDictionary, AFUISiriSession, AFUISiriRemoteViewController, SiriUIAudioRoutePickerController, UIStatusBar, AFUIRequestOptions, NSNumber, UIView;
