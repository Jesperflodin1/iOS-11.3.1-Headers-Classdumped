...
@property (assign,nonatomic) BOOL hasServiceState; 
@property (assign,nonatomic) unsigned long long serviceState;              //@synthesize serviceState=_serviceState - In the implementation block
