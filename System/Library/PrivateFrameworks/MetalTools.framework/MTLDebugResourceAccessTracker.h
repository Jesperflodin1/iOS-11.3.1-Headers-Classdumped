...
+(void)recordRenderTargetAccessesForEndEncoding:(BOOL)arg1 descriptor:(id)arg2 renderPipelineState:(id)arg3 depthStencilState:(id)arg4 deferredAttachments:(ResourceTrackingDeferredAttachments*)arg5 viewport:(SCD_Struct_MT1*)arg6 viewportCount:(unsigned)arg7 scissor:(SCD_Struct_MT2*)arg8 scissorCount:(unsigned)arg9 ;
