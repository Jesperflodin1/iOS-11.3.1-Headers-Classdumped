...
@class AVCaptureSession, AVCaptureDeviceInput, AVCaptureVideoPreviewLayer, UIView, UILabel, NSDate, NSString, NSTimer, AVPlayer, BKUIPearlMovieLoopView, UIImageView, NSArray, BKUIPearlCrossHairsView, BKUIPearlPositioningGuideView, CAShapeLayer, BKUIPearlPillContainerView;
