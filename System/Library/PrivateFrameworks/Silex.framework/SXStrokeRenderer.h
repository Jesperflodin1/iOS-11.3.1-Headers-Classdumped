...
-(SCD_Struct_SX19)framesForBorder:(id)arg1 contentSize:(CGSize)arg2 ;
-(CGContextRef)newContextForFrame:(CGRect)arg1 ;
-(void)drawDashedSide:(id)arg1 borderSide:(int)arg2 withStyleFrames:(SCD_Struct_SX19)arg3 inContext:(CGContextRef)arg4 ;
