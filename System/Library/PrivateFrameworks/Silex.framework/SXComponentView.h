...
@interface SXComponentView : UIView <UIGestureRecognizerDelegate, STTextCanvasRenderSource, SXAXAssistiveTechStatusChangeListener, SXTransitionDataSource, UIViewControllerPreviewingDelegate> {
	...
	BOOL _hasAnimation;
	BOOL _hasBehaviors;
	SCD_Struct_SX16 _presentationChanges;
...
@property (assign,nonatomic) SCD_Struct_SX16 presentationChanges;                                              //@synthesize presentationChanges=_presentationChanges - In the implementation block
...
-(SCD_Struct_SX16)presentationChanges;
-(void)setPresentationChanges:(SCD_Struct_SX16)arg1 ;
