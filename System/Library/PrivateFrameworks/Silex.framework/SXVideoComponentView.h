...
@class SXVideoPlayerViewController, SXAdController, SXPosterFrameView, SXVideoAnalyticsRouter, SXVideoComponentAnalyticsReporting, SXVolumeProvider, SXVideoPlayerViewControllerManager, ADBannerView, NSString;
