...
@class NSString, NSURL, NSMutableDictionary, UIBarButtonItem, NSLayoutConstraint, UIView, HLPHelpUsageController, HLPHelpLocaleController, HLPHelpBookController, HLPHelpTopicViewController, NSArray, HLPReachabilityManager, HLPHelpLoadingView, HLPHelpTableOfContentViewController;
...
@property (assign,setter=_setFullBookView:,getter=_fullBookView,nonatomic) BOOL _fullBookView;                //@synthesize _fullBookView=__fullBookView - In the implementation block
