...
-(int)forwardMeeting:(id)arg1 withServerId:(id)arg2 withInstanceId:(id)arg3 withFolderId:(id)arg4 toEmailAddresses:(id)arg5 withAttendeeUUIDs:(id)arg6 consumer:(id)arg7 ;
