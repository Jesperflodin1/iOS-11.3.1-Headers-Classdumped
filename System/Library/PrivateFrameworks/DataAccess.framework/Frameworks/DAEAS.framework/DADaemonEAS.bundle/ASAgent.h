...
-(void)_smartMailTask:(id)arg1 failedWithErrorCode:(int)arg2 error:(id)arg3 ;
...
-(void)_addSimpleChangeForType:(unsigned long long)arg1 changedItemId:(id)arg2 addedIds:(id)arg3 modifiedIds:(id)arg4 deletedIds:(id)arg5 collapsedIds:(id)arg6 ;
-(BOOL)_getHierarchyChangeForDataclass:(long long)arg1 changedItemId:(int*)arg2 changeType:(unsigned long long*)arg3 externalId:(id*)arg4 changeTableIndices:(CFArrayRef)arg5 ;
-(BOOL)_handleLocallyChangedFolderWithChangedItemId:(int)arg1 changeType:(unsigned long long)arg2 externalId:(id)arg3 changeTableIndices:(CFArrayRef)arg4 dataclass:(long long)arg5 ;
...
-(void)_addChangeForType:(unsigned long long)arg1 changedItemId:(id)arg2 changeId:(id)arg3 addedIdsToChangeId:(id)arg4 modifiedIdsToChangeId:(id)arg5 deletedIdsToChangeId:(id)arg6 pseudoDeletedIdsToChangeId:(id)arg7 changeIdsToClear:(id)arg8 ;
-(id)_dbExternalIdForLocalId:(int)arg1 dataclass:(long long)arg2 ;
-(BOOL)_isOrganizerSelfWithLocalEvent:(void*)arg1 ;
-(void)_handleChangeOnEventWithExchangeId:(id)arg1 localId:(int)arg2 changeType:(unsigned long long)arg3 eventChangeId:(id)arg4 hasSignificantAttributeChanges:(BOOL)arg5 container:(void*)arg6 dataHandler:(id)arg7 addedIdsToEventChangeId:(id)arg8 modifiedIdsToEventChangeId:(id)arg9 deletedIdsToEventChangeId:(id)arg10 pseudoDeletedIdsToEventChangeId:(id)arg11 eventChangeIdsToClear:(id)arg12 allAddedDetachmentIds:(id)arg13 localToExchangeIdMap:(id)arg14 outShouldSaveDB:(BOOL*)arg15 ;
-(BOOL)_isOrganizerSelfWithEmail:(id)arg1 ;
...
-(void)_attendeeChangesDueToMeetingForwardingInCalendar:(void*)arg1 eventIdToAttendeeEmails:(id)arg2 eventIdToAttendeeUUIDs:(id)arg3 dataHandler:(id)arg4 ;
