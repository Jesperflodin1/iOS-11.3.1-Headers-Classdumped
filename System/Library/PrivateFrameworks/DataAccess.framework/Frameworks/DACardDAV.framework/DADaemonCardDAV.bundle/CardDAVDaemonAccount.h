...
-(BOOL)_fillOutExternalURLForRecordType:(unsigned)arg1 localId:(int)arg2 changeType:(unsigned long long)arg3 inFolderWithURL:(id)arg4 outNewExternalURL:(id*)arg5 outTouchedDB:(BOOL*)arg6 ;
