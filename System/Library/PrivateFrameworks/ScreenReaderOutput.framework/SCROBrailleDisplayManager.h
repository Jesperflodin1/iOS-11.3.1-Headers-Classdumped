...
@class NSLock, SCROBrailleDisplayManagedQueue, SCROBrailleDisplay, NSMutableDictionary, SCROBrailleFormatter, NSMutableSet, NSMutableArray, SCROBrailleDisplayHistory, NSAttributedString, SCROBrailleDisplayManagerStatus, SCROBrailleEventDispatcher, NSString;
