...
-(void)addText:(id)arg1 overrideText:(id)arg2 language:(id)arg3 selection:(NSRange*)arg4 token:(long long)arg5 focus:(NSRange*)arg6 technical:(BOOL)arg7 isEditableText:(BOOL)arg8 paddingRange:(NSRange)arg9 ;
