...
@class NSLock, SCROBrailleLine, NSString, SCROBrailleDisplayStatus, SCROBrailleEventDispatcher, NSMutableArray, SCROBrailleDisplayInput;
...
-(id)_translatedBrailleStringAndKeyEvents:(out id*)arg1 replacementRange:(out NSRange*)arg2 cursor:(out unsigned long long*)arg3 ;
