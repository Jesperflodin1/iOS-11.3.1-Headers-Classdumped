...
@property (nonatomic,retain) NSObject*<OS_dispatch_source> indexIdleTimer;               //@synthesize indexIdleTimer=_indexIdleTimer - In the implementation block
...
-(id)_startQueryWithQueryTask:(id)arg1 resultsHandler:(/*^block*/id)arg2 ;
...
-(void)startQueryWithQueryTask:(id)arg1 startHandler:(/*^block*/id)arg2 resultsHandler:(/*^block*/id)arg3 ;
...
-(void)setIndexIdleTimer:(NSObject*<OS_dispatch_source>)arg1 ;
