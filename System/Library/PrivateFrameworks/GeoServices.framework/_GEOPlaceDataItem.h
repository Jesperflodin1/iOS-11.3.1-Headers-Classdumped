...
@class GEOMapItemIdentifier, GEOPDPlace, GEOPlace, NSMapTable, GEOPDMultiLocalizedString, GEOMapItemDetourInfo, _GEOEncyclopedicInfo, GEOAddressObject, NSString, NSData, NSArray, GEOMapRegion, GEOAddress, NSDictionary, NSTimeZone, NSDate, GEOAssociatedApp, GEOMapItemClientAttributes, GEOPDFlyover, GEOPriceDescription, NSURL, GEOMapItemPlaceAttribution, GEOMapItemPhotosAttribution, GEOMapItemReviewsAttribution, GEOFeatureStyleAttributes, GEOPDBusinessClaim, GEORestaurantFeaturesLink, GEOMessageLink, GEOMapItemContainedPlace;
