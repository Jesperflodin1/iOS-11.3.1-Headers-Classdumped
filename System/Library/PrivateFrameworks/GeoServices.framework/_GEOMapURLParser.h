...
@property (readonly) SCD_Struct_GE29 centerCoordinate;                           //@synthesize centerCoordinate=_centerCoordinate - In the implementation block
@property (readonly) SCD_Struct_GE29 span;                                       //@synthesize span=_span - In the implementation block
...
@property (readonly) SCD_Struct_GE29 searchCoordinate;                           //@synthesize searchCoordinate=_searchCoordinate - In the implementation block
@property (readonly) SCD_Struct_GE43 searchRegion;                               //@synthesize searchRegion=_searchRegion - In the implementation block
