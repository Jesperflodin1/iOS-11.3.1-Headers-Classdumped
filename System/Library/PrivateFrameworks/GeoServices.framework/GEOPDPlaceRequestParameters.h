...
-(id)initWithSearchURLQuery:(id)arg1 coordinate:(SCD_Struct_GE29)arg2 muid:(unsigned long long)arg3 resultProviderId:(int)arg4 contentProvider:(id)arg5 ;
...
-(id)initWithReverseGeocodeCoordinate:(SCD_Struct_GE29)arg1 preserveOriginalLocation:(BOOL)arg2 ;
-(id)initWithReverseGeocodeCoordinate:(SCD_Struct_GE29)arg1 preserveOriginalLocation:(BOOL)arg2 floorOrdinal:(int)arg3 ;
...
-(id)initWithReverseGeocodeCoordinate:(SCD_Struct_GE29)arg1 ;
