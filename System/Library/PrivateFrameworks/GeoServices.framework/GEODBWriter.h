...
@class NSString, NSDictionary, NSMutableArray, NSMutableSet, NSLock, NSObject;
...
@interface GEODBWriter : NSObject {
	...
	SCD_Struct_GE64* _expirationRecords;
...
-(void)setExpirationRecords:(SCD_Struct_GE64*)arg1 count:(unsigned long long)arg2 ;
