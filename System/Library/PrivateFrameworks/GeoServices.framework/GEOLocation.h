...
-(id)initWithGEOCoordinate:(SCD_Struct_GE29)arg1 ;
...
-(id)initWithGEOCoordinate:(SCD_Struct_GE29)arg1 isUserLocation:(BOOL)arg2 floorOrdinal:(int)arg3 ;
-(id)initWithLatitude:(double)arg1 longitude:(double)arg2 isUserLocation:(BOOL)arg3 floorOrdinal:(int)arg4 ;
-(id)initWithLocation:(id)arg1 ;
-(id)initWithGEOCoordinate:(SCD_Struct_GE29)arg1 isUserLocation:(BOOL)arg2 ;
-(id)initWithGEOCoordinate:(SCD_Struct_GE29)arg1 floorOrdinal:(int)arg2 ;
