...
@class GEODataRequest, NSObject, NSURLSessionDataTask, NSError, NSData, NSMutableData, NSURLSessionTaskMetrics, GEODataURLSessionTaskQueue, NSString, NSURL, NSHTTPURLResponse, NSURLRequest, GEOClientMetrics;
...
@property (nonatomic,retain) GEODataURLSessionTaskQueue * taskQueue;                          //@synthesize taskQueue=_taskQueue - In the implementation block
...
-(id)init;
-(GEODataURLSessionTaskQueue *)taskQueue;
-(void)cancel;
...
-(void)start;
-(double)startTime;
-(void)setTaskQueue:(GEODataURLSessionTaskQueue *)arg1 ;
-(float)_priority;
