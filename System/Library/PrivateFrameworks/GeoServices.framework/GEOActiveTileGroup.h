...
@class PBUnknownFields, NSString, NSMutableArray, GEODataSetDescription, NSData, GEOVersionManifest;
...
@interface GEOActiveTileGroup : PBCodable <NSCopying> {
	...
	GEOMapLayersMetadata _mapLayersMetadata;
...
@property (nonatomic,retain) NSMutableArray * mapLayers;                                      //@synthesize mapLayers=_mapLayers - In the implementation block
@property (assign,nonatomic) BOOL hasOperationMode; 
@property (assign,nonatomic) int operationMode;                                               //@synthesize operationMode=_operationMode - In the implementation block
...
@property (assign,nonatomic) BOOL hasMapLayersMetadata; 
@property (assign,nonatomic) GEOMapLayersMetadata mapLayersMetadata;                          //@synthesize mapLayersMetadata=_mapLayersMetadata - In the implementation block
...
@property (nonatomic,retain) NSString * bluePOIURL;                                           //@synthesize bluePOIURL=_bluePOIURL - In the implementation block
...
-(id)regionalResourcesForMapRect:(SCD_Struct_GE43)arg1 ;
...
-(void)setMapLayersMetadata:(GEOMapLayersMetadata)arg1 ;
...
-(void)setMapLayers:(NSMutableArray *)arg1 ;
