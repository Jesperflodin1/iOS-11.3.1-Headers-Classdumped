...
@class PBUnknownFields, GEOAdditionalEnabledMarkets, GEOAddress, GEOBusinessOptions, GEOClientCapabilities, NSString, GEOLatLng, NSMutableArray, GEOIndexQueryNode, GEOLocation, GEOMapRegion, GEOSearchSubstring, GEOSuggestionsOptions, NSData;
...
@interface GEOPlaceSearchRequest : PBRequest <NSCopying> {
	...
	SCD_Struct_GE59* _businessIDs;
	SCD_Struct_GE2* _optionalSuppressionReasons;
	long long _geoId;
