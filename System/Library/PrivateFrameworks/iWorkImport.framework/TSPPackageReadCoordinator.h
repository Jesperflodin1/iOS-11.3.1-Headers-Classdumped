...
@class TSPObjectContext, NSUUID, TSPObject, TSPPackage, NSURL, TSPFinalizeHandlerQueue, TSPPackageMetadata, TSPPersistedObjectUUIDMap, NSMutableSet, NSObject, NSMutableArray, NSMapTable, NSSet, TSPDocumentRevision, TSPObjectContainer, NSString;
