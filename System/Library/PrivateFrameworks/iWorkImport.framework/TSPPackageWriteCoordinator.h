...
@class NSURL, TSPObjectContext, TSPDocumentRevision, TSPObject, TSPDataAttributesSnapshot, TSPObjectReferenceMap, TSPArchiverManager, NSObject, NSSet, NSMutableSet, TSPObjectContainer, TSPPersistedObjectUUIDMap, NSHashTable, TSPComponentExternalReferenceMap, NSMutableArray, TSPPackageMetadata, NSString;
...
-(void)enqueueRootObject:(id)arg1 forceArchive:(BOOL)arg2 failToAutosaveOnArchive:(BOOL)arg3 isAddingDelayedObjectReferencedByObjectContainer:(BOOL)arg4 completion:(/*^block*/id)arg5 ;
-(void)enqueueRootObjectImpl:(id)arg1 forceArchive:(BOOL)arg2 failToAutosaveOnArchive:(BOOL)arg3 isAddingDelayedObjectReferencedByObjectContainer:(BOOL)arg4 completion:(/*^block*/id)arg5 ;
