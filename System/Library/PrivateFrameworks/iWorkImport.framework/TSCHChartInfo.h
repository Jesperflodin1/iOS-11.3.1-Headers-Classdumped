...
@property (assign,nonatomic) SCD_Struct_TS514 defaultLayoutSettings; 
...
-(id)create3DSceneWithLayoutSettings:(const SCD_Struct_TS514*)arg1 ;
-(void)clearParent;
...
-(void)setDefaultLayoutSettings:(SCD_Struct_TS514)arg1 ;
-(SCD_Struct_TS514)defaultLayoutSettings;
