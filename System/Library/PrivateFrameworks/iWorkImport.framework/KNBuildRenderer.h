...
@class NSMapTable, CALayer, NSMutableArray, TSDTextureSet, KNAnimationInfo, KNAnimatedBuild, KNBuildChunk, TSDDrawableInfo, TSDFPSCounter, TSDTextureDescription, NSArray, TSDRep, NSString;
