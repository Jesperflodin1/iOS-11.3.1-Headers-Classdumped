...
-(void)saveToMessage:(LargeStringToObjectDictionarySegment*)arg1 archiver:(id)arg2 ;
-(void)saveToArchiver:(id)arg1 ;
-(void)loadFromUnarchiver:(id)arg1 ;
-(void)loadFromMessage:(const LargeStringToObjectDictionarySegment*)arg1 unarchiver:(id)arg2 ;
