...
@class KNSlideStyle, KNSlideBackgroundInfo, NSOrderedSet, NSSet, NSArray, TSUPointerKeyDictionary, TSUMutablePointerSet, KNTransition, KNTitlePlaceholderInfo, KNBodyPlaceholderInfo, KNObjectPlaceholderInfo, KNSlideNumberPlaceholderInfo, KNSlideNode, TSDFill, NSDictionary, NSString, TSDInfoGeometry;
...
@property (nonatomic,readonly) BOOL inDocument;                                                        //@synthesize inDocument=_inDocument - In the implementation block
