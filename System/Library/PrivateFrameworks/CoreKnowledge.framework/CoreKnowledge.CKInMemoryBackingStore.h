...
@class NSString, CKPersistentStoreHandler;
...
@property (readonly,nonatomic) CKPersistentStoreHandler * inMemoryStoreHandler; 
-(id)init;
...
-(CKPersistentStoreHandler *)inMemoryStoreHandler;
...
-(void)triplesComponentsMatching:(id)arg1 completionHandler:(/*^block*/id)arg2 ;
