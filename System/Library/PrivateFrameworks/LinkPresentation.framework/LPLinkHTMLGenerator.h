...
@class LPMetadataProvider, LPCaptionBarPresentationProperties, NSString, LPImage, LPVideo, UIColor, LPPointUnit, DOMElement, LPHTMLComponent, LPHTMLVideoComponent, LPLinkMetadata, NSURL, DOMDocument, LPCSSResolver, LPTheme, DOMDocumentFragment;
