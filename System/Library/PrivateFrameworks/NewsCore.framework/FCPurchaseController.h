...
-(void)shouldShowSignedInWithDifferentiTunesAccountAlertWithAccount:(id)arg1 completion:(/*^block*/id)arg2 ;
-(void)shouldShowiTunesSignedOutAlertWithAccount:(id)arg1 completion:(/*^block*/id)arg2 ;
