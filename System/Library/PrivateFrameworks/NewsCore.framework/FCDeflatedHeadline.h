...
@class NSString, NSDate, FCHeadlineThumbnail, NSURL, NSArray, FCCoverArt, NSSet, FCFeedPersonalizedArticleScoreProfile, FCTopStoriesStyleConfiguration, NSData, NTPBFeedViewportHeadline, FCSharedStringIndex, COMAPPLEFELDSPARPROTOCOLLIVERPOOLCohort;
