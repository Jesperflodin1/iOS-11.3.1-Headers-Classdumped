...
@class FCSubscriptionList, FCTagController, FCThreadSafeMutableDictionary, FCThreadSafeMutableSet, NSHashTable, FCNotificationController, FCPurchaseController, FCAppConfigurationManager, NSString;
...
-(void)_fetchExtraTagsWithPreSubscribedNotificationSupportWithCompletion:(/*^block*/id)arg1 ;
