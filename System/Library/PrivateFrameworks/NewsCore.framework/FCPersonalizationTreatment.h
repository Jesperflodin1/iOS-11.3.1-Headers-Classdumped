...
@property (nonatomic,readonly) double baselineArticleScore;                                                  //@synthesize baselineArticleScore=_baselineArticleScore - In the implementation block
@property (nonatomic,readonly) double minimumGlobalScoreThreshold;                                           //@synthesize minimumGlobalScoreThreshold=_minimumGlobalScoreThreshold - In the implementation block
@property (nonatomic,readonly) double minimumGlobalScoreThresholdForSubscribedChannel;                       //@synthesize minimumGlobalScoreThresholdForSubscribedChannel=_minimumGlobalScoreThresholdForSubscribedChannel - In the implementation block
