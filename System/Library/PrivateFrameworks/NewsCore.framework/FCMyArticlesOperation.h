...
@class FCCloudContext, FCDateRange, NSArray, FCFeedPersonalizedArticles, NSDictionary, NSError;
...
@property (retain) FCFeedPersonalizedArticles * nonEditorialPersonalizedArticles;              //@synthesize nonEditorialPersonalizedArticles=_nonEditorialPersonalizedArticles - In the implementation block
...
-(void)setNonEditorialPersonalizedArticles:(FCFeedPersonalizedArticles *)arg1 ;
