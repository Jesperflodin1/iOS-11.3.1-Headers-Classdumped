...
@class NSString, FCHeadlineThumbnail, NSArray, NSDate, NSURL, NSSet, FCFeedPersonalizedArticleScoreProfile, FCTopStoriesStyleConfiguration, FCCoverArt, COMAPPLEFELDSPARPROTOCOLLIVERPOOLCohort, NSData;
