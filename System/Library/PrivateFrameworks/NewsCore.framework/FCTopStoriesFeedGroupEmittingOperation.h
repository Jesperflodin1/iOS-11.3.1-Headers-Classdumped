...
-(void)_selectHeadlinesFromMandatory:(id)arg1 optional:(id)arg2 articleMetadataByArticleID:(id)arg3 cursor:(id)arg4 isAllowedToCollapse:(BOOL)arg5 completion:(/*^block*/id)arg6 ;
