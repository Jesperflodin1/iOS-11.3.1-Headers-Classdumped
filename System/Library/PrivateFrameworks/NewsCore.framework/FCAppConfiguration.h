...
@class FCNotificationsConfiguration, NSArray, NSDictionary, FCTopStoriesConfiguration, NSString, FCForYouGroupsConfiguration, NTPBVideoGroupsConfig, NSNumber, FCIAdConfiguration, FCPrefetchConfiguration, FCCoverArticlesConfiguration, NTPBDiscoverMoreVideosInfo, NTPBConfig, NTPBLanguageConfig, NTPBWidgetConfig, FCRecommendedCategory;
...
@property (nonatomic,copy,readonly) NTPBWidgetConfig * widgetConfig;                                                                   //@synthesize widgetConfig=_widgetConfig - In the implementation block
...
@property (nonatomic,copy,readonly) NTPBVideoGroupsConfig * forYouVideoGroupsConfig; 
