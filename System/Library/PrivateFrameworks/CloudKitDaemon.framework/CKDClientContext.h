...
@class CKDServerConfiguration, NSURL, NSString, NSHashTable, CKContainerID, NSBundle, CKDAccount, CKAccountOverrideInfo, CKDMMCS, CKTimeLogger, CKDPCSCache, CKDZoneGatekeeper, CKDMescalSession, NSMutableDictionary, NSObject, CKDCachePurger, CKDKeyValueDiskCache, CKDPublicIdentityLookupService, CKDAppContainerIntersectionMetadata, CKDApplicationMetadata, CKDAppContainerTuple, CKDFlowControlManager, CKDPCSManager;
