...
-(IDSTCPConnection_*)_getIDSTCPConnection:(SCD_Struct_ID2*)arg1 ;
...
-(long long)getPacketLength:(SCD_Struct_ID2*)arg1 isChannelData:(BOOL*)arg2 ;
...
-(void)processIncomingPacket:(SCD_Struct_ID2*)arg1 ;
-(BOOL)isSSL;
