...
@class NSUUID, NSData, HKHealthService, _HKFitnessMachine, HDHealthServiceOOBInfo, HDFitnessMachineStatus, HDFitnessMachineDataCharacteristicBase, HDEnhancedFTMSData, NSDate, NSArray, NSString;
