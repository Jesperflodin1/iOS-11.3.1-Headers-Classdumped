...
@protocol OS_dispatch_queue, HDAchievementDefinitionAlertNotifier, HDAchievementDefinitionAlertSuppressor, HDNanoAlertSuppressionService, HDAchievementEvaluationDelegate, HDDaemonTester;
@class HDBackgroundTaskScheduler, HDPluginManager, HDPrimaryProfile, HDAchievementDefinitionAlertManager, _HKBehavior, NSString, NSMutableSet, NSObject, HDContentProtectionManager, HDCloudSyncCoordinator, HDDemoDataGenerator, HDProcessStateManager, HDProfileManager, HDDynamicAchievementDefinitionDataStore, NSMutableArray, NSDictionary, HDAnalyticsSubmissionCoordinator, HDAchievementAssetManager, HDCompanionAchievementManager, HDCoachingDiagnosticManager, HDCompanionWorkoutCreditManager, HDFitnessAppBadgeManager, HDQueryManager, HDXPCListener, HDAppLauncher, NSURL;
...
@property (nonatomic,retain) HDCompanionAchievementManager * companionAchievementManager;                                  //@synthesize companionAchievementManager=_companionAchievementManager - In the implementation block
...
@property (nonatomic,retain) HDDynamicAchievementDefinitionDataStore * dynamicAchievementDefinitionDataStore;              //@synthesize dynamicAchievementDefinitionDataStore=_dynamicAchievementDefinitionDataStore - In the implementation block
...
@property (assign,nonatomic,__weak) id<HDAchievementEvaluationDelegate> achievementEvaluationDelegate;                     //@synthesize achievementEvaluationDelegate=_achievementEvaluationDelegate - In the implementation block
...
-(HDCompanionAchievementManager *)companionAchievementManager;
...
-(HDDynamicAchievementDefinitionDataStore *)dynamicAchievementDefinitionDataStore;
...
-(void)setCompanionAchievementManager:(HDCompanionAchievementManager *)arg1 ;
-(void)setDynamicAchievementDefinitionDataStore:(HDDynamicAchievementDefinitionDataStore *)arg1 ;
...
-(id<HDAchievementEvaluationDelegate>)achievementEvaluationDelegate;
-(void)setAchievementEvaluationDelegate:(id<HDAchievementEvaluationDelegate>)arg1 ;
