...
@class HDProfile, NSObject, NSMutableArray, HDFitnessMachineDataCollector, HDFitnessMachinePairingManager, HDFitnessMachineSession, HDFitnessMachineDataProducer, NSDate, HDHealthServiceManager, HDFitnessMachineStateTimers, HDFitnessMachineAnalyticsCollector, NSString;
