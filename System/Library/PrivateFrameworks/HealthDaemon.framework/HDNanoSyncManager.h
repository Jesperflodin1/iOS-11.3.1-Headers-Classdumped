...
@class HKNanoSyncPairedDevicesSnapshot, HDProfile, NSObject, HDIDSMessageCenter, NSHashTable, HDKeyValueDomain, HDNanoSyncStore, NSMutableDictionary, NSArray, NSDate, HDPairedSyncManager, NSString;
