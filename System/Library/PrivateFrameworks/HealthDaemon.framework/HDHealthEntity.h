...
+(id)predicateForSyncWithPredicate:(id)arg1 session:(id)arg2 syncAnchorRange:(HDSyncAnchorRange)arg3 ;
...
+(BOOL)enumerateEntitiesForSyncWithProperties:(id)arg1 predicate:(id)arg2 session:(id)arg3 syncAnchorRange:(HDSyncAnchorRange)arg4 orderingProperties:(id)arg5 orderingDirections:(id)arg6 limit:(unsigned long long)arg7 lastSyncAnchor:(long long*)arg8 healthDatabase:(id)arg9 error:(id*)arg10 block:(/*^block*/id)arg11 ;
