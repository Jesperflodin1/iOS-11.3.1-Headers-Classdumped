...
@class NSObject, PKPaymentPass, PKLinkedApplication, PKPaymentApplication, PKPaymentWebService, PKPaymentVerificationController, PKPaymentPassDetailActivationFooterView, PKSettingTableCell, NSNumber, PKPaymentTransactionCellController, NSArray, NSDateFormatter, NSNumberFormatter, LAContext, PKExpressPassInformation, PKTransitPassProperties, NSDateComponentsFormatter, NSMutableDictionary, UIView, PKPassHeaderView, UIVisualEffectView, UISegmentedControl, PKPeerPaymentWebService, PKPeerPaymentController, PKPeerPaymentAccount, PKPeerPaymentContactResolver, PKPeerPaymentPreferences, PKSpinnerHeaderView, PKPeerPaymentPerformActionViewController, NSIndexPath, PKPeerPaymentAccountResolutionController, UIColor, NSString;
