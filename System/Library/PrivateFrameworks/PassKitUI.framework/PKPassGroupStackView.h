...
@class PKPassGroupView, PKGroup, NSMutableArray, NSMutableDictionary, PKPGSVSectionHeaderContext, UIView, UIImageView, PKPassDeleteAnimationController, PKReusablePassViewQueue, NSTimer, PKPaymentService, PKPassFooterView, PKPassthroughView, PKSecureElement, UIColor, PKPass, NSString;
