...
@class _UIBackdropView, UIView, PKPhysicalButtonView, UILabel, UIStackView, PKContinuityPaymentCardSummaryView, PKPaymentAuthorizationFooterView, PKContinuityPaymentFaviconView, UIViewController, NSArray, PKAuthenticator, PKPaymentAuthorizationStateMachine, NSTimer, PKRemotePaymentRequest, NSString;
