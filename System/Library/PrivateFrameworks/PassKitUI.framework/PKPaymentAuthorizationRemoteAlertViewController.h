...
@class NSString, PKAssertion, PKPaymentRequest, PKCompactNavigationContainerController, PKPaymentAuthorizationServiceNavigationController, PKPhysicalButtonView, PKPaymentProvisioningController, PKPaymentSetupNavigationController, PKPaymentAuthorizationRemoteAlertViewControllerExportedObject, PKInAppPaymentService, NSXPCConnection;
