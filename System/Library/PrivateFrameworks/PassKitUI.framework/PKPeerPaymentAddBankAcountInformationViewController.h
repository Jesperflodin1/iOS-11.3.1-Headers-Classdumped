...
@class PKTableHeaderView, PKPeerPaymentFindBankAccountInformationFooterView, UIButton, PKPeerPaymentBankAccountInformation, NSArray, NSMutableDictionary, NSString;
...
@property (assign,nonatomic,__weak) id<PKPeerPaymentAddBankAcountInformationViewControllerDelegate> delegate;              //@synthesize delegate=_delegate - In the implementation block
...
-(void)cancel:(id)arg1 ;
-(id)init;
-(id<PKPeerPaymentAddBankAcountInformationViewControllerDelegate>)delegate;
-(void)setDelegate:(id<PKPeerPaymentAddBankAcountInformationViewControllerDelegate>)arg1 ;
-(void)dealloc;
