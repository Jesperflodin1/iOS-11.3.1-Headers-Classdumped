...
@class NSLayoutConstraint, ICLabel, NSMutableDictionary, UIImageView, UIView, UIImage, UIColor;
...
@property (assign,nonatomic) SCD_Struct_IC6 movieDuration;                                      //@synthesize movieDuration=_movieDuration - In the implementation block
...
-(void)setMovieDuration:(SCD_Struct_IC6)arg1 ;
