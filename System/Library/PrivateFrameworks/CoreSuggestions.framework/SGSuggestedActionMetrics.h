...
@class SGMContactInBanner, SGMContactConfirmed, SGMContactRejected, SGMContactDetailConfirmed, SGMContactDetailRejected, SGMContactDetailUsed, SGMEventInBanner, SGMEventBannerConfirmed, SGMEventBannerRejected, SGMMaybeInformationShown, SGMUnknownContactInformationShown;
