...
@class SGDaemonConnection, NSString, SGKeyValueCacheFile;
...
-(void)namesForUnknownDetail:(id)arg1 limitTo:(unsigned long long)arg2 prependMaybe:(BOOL)arg3 withCompletion:(/*^block*/id)arg4 ;
...
-(void)modelMetadataUpdateWithPayload:(id)arg1 completion:(/*^block*/id)arg2 ;
