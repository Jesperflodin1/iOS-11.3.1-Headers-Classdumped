...
@property (retain) NSHashTable * rowModels;                                    //@synthesize rowModels=_rowModels - In the implementation block
...
@property (retain) WLKCanonicalPlayablesResponse * response;                   //@synthesize response=_response - In the implementation block
...
@property (assign) BOOL isInUpNext;                                            //@synthesize isInUpNext=_isInUpNext - In the implementation block
