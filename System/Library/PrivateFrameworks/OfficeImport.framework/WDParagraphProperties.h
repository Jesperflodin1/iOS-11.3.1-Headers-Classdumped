...
@interface WDParagraphProperties : NSObject <NSCopying> {
	...
	SCD_Struct_WD119* mTrackedProperties;
...
-(void)setDropCap:(SCD_Struct_WD118)arg1 ;
...
-(void)addTabStopAdded:(SCD_Struct_WD120*)arg1 ;
...
-(SCD_Struct_WD118)dropCap;
-(unsigned long long)tabStopAddedCount;
-(SCD_Struct_WD120*)tabStopAddedAt:(unsigned long long)arg1 ;
...
-(BOOL)isAnythingOverriddenIn:(SCD_Struct_WD119*)arg1 ;
@end
