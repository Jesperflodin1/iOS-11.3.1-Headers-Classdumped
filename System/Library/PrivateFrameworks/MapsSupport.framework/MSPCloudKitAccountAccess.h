...
@class NSString, CKContainer, CKDatabase, CKRecordZoneID, NSUUID, NSDate, MSPJournal, NSObject, MSPCloudCoalescedOperationExecutor, MSPLongLivedCKOpScopedCache;
...
@property (nonatomic,retain) MSPLongLivedCKOpScopedCache * longLivedOpCache;              //@synthesize longLivedOpCache=_longLivedOpCache - In the implementation block
...
-(void)_rescheduleAllLongLivedOperationsWithHandler:(/*^block*/id)arg1 completionGroup:(id)arg2 thenContinue:(/*^block*/id)arg3 ;
-(id)newGroupForSubscriptionsAndZoneChanges;
-(id)statesToReport;
-(MSPLongLivedCKOpScopedCache *)longLivedOpCache;
-(void)setLongLivedOpCache:(MSPLongLivedCKOpScopedCache *)arg1 ;
@end
