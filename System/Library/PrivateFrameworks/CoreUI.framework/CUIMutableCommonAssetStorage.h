...
-(void)_setZeroCodeInfo:(SCD_Struct_CU18)arg1 forKey:(const void*)arg2 withLength:(unsigned long long)arg3 inTree:(const void*)arg4 ;
...
-(void)setZeroCodeGlyphInformation:(SCD_Struct_CU18)arg1 forKey:(const void*)arg2 withLength:(unsigned long long)arg3 ;
-(void)setZeroCodeBezelInformation:(SCD_Struct_CU18)arg1 forKey:(const void*)arg2 withLength:(unsigned long long)arg3 ;
-(void)dealloc;
