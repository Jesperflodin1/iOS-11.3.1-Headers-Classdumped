...
@interface CUIShapeEffectPreset : NSObject {
	...
	SCD_Struct_CU25 _parameterList[125];
...
-(void)_insertEffectTuple:(SCD_Struct_CU26)arg1 atEffectIndex:(unsigned long long)arg2 ;
...
-(id)initWithConstantPreset:(const SCD_Struct_CU27*)arg1 ;
-(id)init;
-(id)debugDescription;
