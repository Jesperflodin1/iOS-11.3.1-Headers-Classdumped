...
-(void)_unregisterForStreamControlNotifications:(OpaqueFigCaptureStreamRef)arg1 ;
-(void)_registerForStreamControlNotifications:(OpaqueFigCaptureStreamRef)arg1 ;
