...
@class NSDictionary, NSString, NSArray, NSData, BWSphereModeSelector, BWStillImageTimeMachine, BWStillImageCaptureSettings, NSMutableArray, NSObject, NSMutableDictionary, FigPAMFrameScore;
...
@property (assign,nonatomic) BOOL multiBandNoiseReductionEnabled; 
