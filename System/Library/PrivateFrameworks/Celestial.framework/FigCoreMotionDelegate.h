...
@interface FigCoreMotionDelegate : NSObject {
	...
	SCD_Struct_Fi74 fusedRingAccel[256];
	SCD_Struct_Fi75 fusedRingQuaternion[256];
	SCD_Struct_Fi74 fusedRingPosition[256];
	...
	SCD_Struct_Fi75 previousQuaternion;
	SCD_Struct_Fi75 currentQuaternion;
	BOOL computingPosition;
	SCD_Struct_Fi83 position;
	SCD_Struct_Fi83 velocity;
...
-(void)didUpdatePositionWithAcceleration:(SCD_Struct_Fi74*)arg1 forTimeStamp:(double)arg2 ;
-(void)didUpdateVelocityWithAcceleration:(SCD_Struct_Fi74*)arg1 forTimeStamp:(double)arg2 ;
-(void)didUpdatePositionWithTimeStamp:(double)arg1 ;
-(void)getCurrentDeltaQuaternion:(SCD_Struct_Fi75*)arg1 ;
-(void)updateDeviceCallback:(BOOL)arg1 fusedMotionUpdateInterval:(float)arg2 ;
-(void)updateGyroInterval:(float)arg1 ;
-(void)didUpdateAcceleration:(SCD_Struct_Fi74)arg1 time:(double)arg2 ;
-(void)didUpdateGravity:(SCD_Struct_Fi74)arg1 time:(double)arg2 ;
...
-(void)didUpdateFusedMotionWithDeviceMotion:(SCD_Struct_Fi84)arg1 time:(double)arg2 ifsync:(BOOL)arg3 ;
...
-(void)getCurrentQuaternion:(SCD_Struct_Fi75*)arg1 ;
